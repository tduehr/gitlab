...
class Gitlab::Gem::Client
  ...
  module Branches
    ...
    #
    # @example
    #   Gitlab::Gem.branch(3, 'api')
    #   Gitlab::Gem.repo_branch(5, 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.protect_branch(3, 'api')
    #   Gitlab::Gem.repo_protect_branch(5, 'master')
    #   Gitlab::Gem.protect_branch(5, 'api', developers_can_push: true)
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Details about the branch
    ...
    #
    # @example
    #   Gitlab::Gem.unprotect_branch(3, 'api')
    #   Gitlab::Gem.repo_unprotect_branch(5, 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] branch The name of the branch.
    # @return [Gitlab::Gem::ObjectifiedHash] Details about the branch
    ...
    #
    # @example
    #   Gitlab::Gem.create_branch(3, 'api', 'feat/new-api')
    #   Gitlab::Gem.repo_create_branch(5, 'master', 'develop')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_branch(3, 'api')
    #   Gitlab::Gem.repo_delete_branch(5, 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_merged_branches(3)
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.protected_branches(42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.protected_branch(3, 'api')
    #
    # @param  [Integer, String] project The ID or name of a project.
