...
class Gitlab::Gem::Client
  ...
  module ProtectedTags
    ...
    #
    # @example
    #   Gitlab::Gem.protected_tags(1)
    #
    # @param [Integer, String] project(required) The ID or name of a project.
    # @option options [Integer] :page The page number.
    # @option options [Integer] :per_page The number of results per page.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of all protected tags requested
    ...
    #
    # @example
    #   Gitlab::Gem.protected_tag(1, 'release-1-0')
    #
    # @param [Integer, String] project(required) The ID or name of a project.
    # @param [String] name(required) The name of the tag or wildcard
    # @return <Gitlab::Gem::ObjectifiedHash] Information about the requested protected tag
    ...
    #
    # @example
    #    Gitlab::Gem.protect_repository_tag(1, 'release-1-0')
    #    Gitlab::Gem.protect_repository_tag(1, 'release-1-0', create_access_level: 30)
    #
    # @param [Integer, String] project(required) The ID or name of a project.
    # @param [String] name(required) The name of the tag or wildcard
    # @option options [Integer] :create_access_level Access levels allowed to create (defaults: 40, maintainer access level)
    # @return <Gitlab::Gem::ObjectifiedHash] Information about the protected repository tag
    ...
    #
    # @example
    #    Gitlab::Gem.unprotect_repository_tag(1, 'release-1-0')
    #
    # @param [Integer, String] project(required) The ID or name of a project.
    # @param [String] name(required) The name of the tag or wildcard
