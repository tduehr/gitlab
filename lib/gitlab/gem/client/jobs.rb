...
class Gitlab::Gem::Client
  ...
  module Jobs
    ...
    # @example
    #   Gitlab::Gem.jobs(1)
    #   Gitlab::Gem.jobs("project")
    #   Gitlab::Gem.jobs("project", {scope: ["manual", "success"], per_page: 100 })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.pipeline_jobs(1, 2)
    #   Gitlab::Gem.pipeline_jobs("project", 2)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.job_artifacts(1, 2)
    #   Gitlab::Gem.job_artifacts("project", 2)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_artifacts_download(1, "master", "release")
    #   Gitlab::Gem.job_artifacts_download("project", "master", "release")
    #
    # @param  [Integer, String] id, The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.job_trace(1,1)
    #   Gitlab::Gem.job_trace("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_cancel(1,1)
    #   Gitlab::Gem.job_cancel("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_retry(1,1)
    #   Gitlab::Gem.job_retry("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_erase(1,1)
    #   Gitlab::Gem.job_erase("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_play(1,1)
    #   Gitlab::Gem.job_play("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_artifacts_keep(1,1)
    #   Gitlab::Gem.job_artifacts_keep("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.job_artifacts_delete(1,1)
    #   Gitlab::Gem.job_artifacts_delete("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
