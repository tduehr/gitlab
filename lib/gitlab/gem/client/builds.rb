...
class Gitlab::Gem::Client
  ...
  module Builds
    ...
    # @example
    #   Gitlab::Gem.builds(5)
    #   Gitlab::Gem.builds(5, { per_page: 10, page:  2 })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.build_artifacts(1, 8)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a build.
    # @return [Gitlab::Gem::FileResponse]
      ...
      get("/projects/#{url_encode project}/builds/#{id}/artifacts",
          ...
          parser: proc { |body, _|
                    if body.encoding == Encoding::ASCII_8BIT # binary response
                      ::Gitlab::Gem::FileResponse.new StringIO.new(body, 'rb+')
                    else # error with json response
                      ::Gitlab::Gem::Request.parse(body)
                    end
                  })
    end
    ...
    #
    # @example
    #   Gitlab::Gem.commit_builds(5, 'asdf')
    #   Gitlab::Gem.commit_builds(5, 'asdf', { per_page: 10, page: 2 })
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    # @option options [Integer] :page The page number.
    # @option options [Integer] :per_page The number of results per page.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] The list of builds.
    ...
    #
    # @example
    #   Gitlab::Gem.build_cancel(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a build.
    # @return [Gitlab::Gem::ObjectifiedHash] The builds changes.
    ...
    #
    # @example
    #   Gitlab::Gem.build_retry(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a build.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] The builds changes.
    ...
    #
    # @example
    #   Gitlab::Gem.build_erase(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a build.
    # @return [Gitlab::Gem::ObjectifiedHash] The build's changes.
