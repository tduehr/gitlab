...
class Gitlab::Gem::Client
  ...
  module Repositories
    ...
    # @example
    #   Gitlab::Gem.tree(42)
    #   Gitlab::Gem.tree(42, { path: 'Gemfile' })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.repo_archive(42)
    #   Gitlab::Gem.repo_archive(42, 'deadbeef')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.compare(42, 'master', 'feature/branch')
    #   Gitlab::Gem.repo_compare(42, 'master', 'feature/branch')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.merge_base(42, ['master', 'feature/branch'])
    #   Gitlab::Gem.merge_base(42, ['master', 'feature/branch'])
    #
    ...
    #
    # @example
    #   Gitlab::Gem.contributors(42)
    #   Gitlab::Gem.contributors(42, { order: 'name' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Hash] options A customizable set of options.
