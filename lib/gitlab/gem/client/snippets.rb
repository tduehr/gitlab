...
class Gitlab::Gem::Client
  ...
  module Snippets
    ...
    #
    # @example
    #   Gitlab::Gem.create_snippet(42, { title: 'REST', file_name: 'api.rb', code: 'some code', visibility: 'public'})
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_snippet(42, 34, { file_name: 'README.txt' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a snippet.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_snippet(2, 14)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a snippet.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted snippet.
    ...
    #
    # @example
    #   Gitlab::Gem.snippet_content(2, 14)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a snippet.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted snippet.
