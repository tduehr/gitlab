...
class Gitlab::Gem::Client
  ...
  module Boards
    ...
    #
    # @example
    #   Gitlab::Gem.board(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a board.
    # @return [Gitlab::Gem::ObjectifiedHash] Returns information about the board
    ...
    #
    # @example
    #   Gitlab::Gem.create_board(5, 'newboard')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] name The name of the new board.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created board.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_board(5, 1, name: 'new_name')
    #   Gitlab::Gem.edit_board(5, 1, name: 'new_name', assignee_id: 1, milestone_id: 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a board.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated board.
    ...
    #
    # @example
    #   Gitlab::Gem.create_board_list(5, 42, 25)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a board.
    # @param  [Integer] label_id The ID of a label.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created list.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_board_list(6, 1, 12, 5)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] board_id The ID of a board.
    # @param  [Integer] id The ID of a list.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated board list.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_board_list(3, 42, 32)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] board_id The ID of a board.
    # @param  [Integer] id The ID of a list.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted board list.
