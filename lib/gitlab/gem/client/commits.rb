...
class Gitlab::Gem::Client
  ...
  module Commits
    ...
    #
    # @example
    #   Gitlab::Gem.commits('viking')
    #   Gitlab::Gem.repo_commits('gitlab', { ref: 'api' })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.commit(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    #   Gitlab::Gem.repo_commit(3, 'ed899a2f4b50b4370feeea94676502b42383c746')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.commit_refs(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.cherry_pick_commit(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] sha The commit hash or name of a repository branch or tag
    ...
    #
    # @example
    #   Gitlab::Gem.commit_diff(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    #   Gitlab::Gem.repo_commit_diff(3, 'ed899a2f4b50b4370feeea94676502b42383c746')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.commit_comments(5, 'c9f9662a9b1116c838b523ed64c6abdb4aae4b8b')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_commit_comment(5, 'c9f9662a9b1116c838b523ed64c6abdb4aae4b8b', 'Nice work on this commit!')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] sha The commit hash or name of a repository branch or tag.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created comment.
    ...
    #
    # @example
    #   Gitlab::Gem.commit_status(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    #   Gitlab::Gem.commit_status(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6', { name: 'jenkins' })
    #   Gitlab::Gem.commit_status(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6', { name: 'jenkins', all: true })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] sha The commit hash
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.update_commit_status(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'success')
    #   Gitlab::Gem.update_commit_status(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'failed', { name: 'jenkins' })
    #   Gitlab::Gem.update_commit_status(42, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'canceled', { name: 'jenkins', target_url: 'http://example.com/builds/1' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] sha The commit hash
    ...
    #
    # @example
    # Gitlab::Gem.create_commit(2726132, 'master', 'refactors everything', [{action: 'create', file_path: '/foo.txt', content: 'bar'}])
    # Gitlab::Gem.create_commit(2726132, 'master', 'refactors everything', [{action: 'delete', file_path: '/foo.txt'}])
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] hash of commit related data
    ...
    #
    # @example
    #   Gitlab::Gem.commit_merge_requests(5, 'c9f9662a9b1116c838b523ed64c6abdb4aae4b8b')
    #
    # @param [Integer] project The ID of a project.
    # @param [String] sha The commit hash.
    # @option options [Integer] :page The page number.
