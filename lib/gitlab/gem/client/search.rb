...
class Gitlab::Gem::Client
  ...
  module Search
    ...
    #
    # @example
    #   Gitlab::Gem.search_globally('projects', 'gitlab')
    #   Gitlab::Gem.search_globally('issues', 'gitlab')
    #   Gitlab::Gem.search_globally('merge_requests', 'gitlab')
    #   Gitlab::Gem.search_globally('milestones', 'gitlab')
    #   Gitlab::Gem.search_globally('snippet_titles', 'gitlab')
    #   Gitlab::Gem.search_globally('snippet_blobs', 'gitlab')
    #
    ...
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] Returns a list of responses depending on the requested scope.
    ...
    #
    # @example
    #   Gitlab::Gem.search_in_group(1, 'projects', 'gitlab')
    #   Gitlab::Gem.search_in_group(1, 'issues', 'gitlab')
    #   Gitlab::Gem.search_in_group(1, 'merge_requests', 'gitlab')
    #   Gitlab::Gem.search_in_group(1, 'milestones', 'gitlab')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.search_in_project(1, 'issues', 'gitlab')
    #   Gitlab::Gem.search_in_project(1, 'merge_requests', 'gitlab')
    #   Gitlab::Gem.search_in_project(1, 'milestones', 'gitlab')
    #   Gitlab::Gem.search_in_project(1, 'notes', 'gitlab')
    #   Gitlab::Gem.search_in_project(1, 'wiki_blobs', 'gitlab')
    #   Gitlab::Gem.search_in_project(1, 'commits', 'gitlab')
    #   Gitlab::Gem.search_in_project(1, 'blobs', 'gitlab')
    #
