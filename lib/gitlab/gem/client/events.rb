...
class Gitlab::Gem::Client
  ...
  module Events
    ...
    # @example
    #   Gitlab::Gem.events()
    #   Gitlab::Gem.events({ action: 'created', target_type: 'issue' })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.user_events(1)
    #   Gitlab::Gem.user_events(1, { action: created})
    #
    ...
    #
    # @example
    #   Gitlab::Gem.project_events(1)
    #   Gitlab::Gem.project_events(1, { action: created })
    #
