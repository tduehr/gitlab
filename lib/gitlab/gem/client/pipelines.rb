...
class Gitlab::Gem::Client
  ...
  module Pipelines
    ...
    #
    # @example
    #   Gitlab::Gem.pipelines(5)
    #   Gitlab::Gem.pipelines(5, { per_page: 10, page:  2 })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_pipeline(5, 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] ref Reference to commit.
    # @param  [Hash] variables Variables passed to pipelines
    # @return [Gitlab::Gem::ObjectifiedHash] The pipelines changes.
    ...
    #
    # @example
    #   Gitlab::Gem.cancel_pipeline(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a pipeline.
    # @return [Gitlab::Gem::ObjectifiedHash] The pipelines changes.
    ...
    #
    # @example
    #   Gitlab::Gem.retry_pipeline(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a pipeline.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] The pipelines changes.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_pipeline(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a pipeline.
