...
class Gitlab::Gem::Client
  ...
  module Groups
    ...
    # @example
    #   Gitlab::Gem.groups
    #   Gitlab::Gem.groups({ per_page: 40, page: 2 })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_group('new-group', 'group-path')
    #   Gitlab::Gem.create_group('gitlab', 'gitlab-path', { description: 'New Gitlab project' })
    #
    # @param  [String] name The name of a group.
    # @param  [String] path The path of a group.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created group.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_group(42)
    # @param  [Integer] id The ID of a group
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the deleted group.
    def delete_group(id)
    ...
    #
    # @example
    #   Gitlab::Gem.group_members(1)
    #   Gitlab::Gem.group_members(1, { per_page: 40 })
    #
    # @param  [Integer] id The ID of a group.
    # @param  [Hash] options A customizable set of options.
    # @option options [Integer] :page The page number.
    ...
    #
    # @example
    #   Gitlab::Gem.group_merge_requests(5)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.add_group_member(1, 2, 40)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.edit_group_member(1, 2, 40)
    #
    # @param  [Integer] team_id The group id of member to edit.
    # @param  [Integer] user_id The user id of the user to edit.
    # @param  [Integer] access_level Project access level.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about edited team member.
    ...
    #
    # @example
    #   Gitlab::Gem.remove_group_member(1, 2)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.transfer_project_to_group(3, 50)
    #
    # @param  [Integer] id The ID of a group.
    ...
    #
    # @example
    #   Gitlab::Gem.group_search('gitlab')
    #
    ...
    # @example
    #   Gitlab::Gem.group_projects(1)
    #
    # @param [Integer] id The ID of a group
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of projects under a group
    ...
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of subgroups under a group
    ...
    #
    # @example
    #   Gitlab::Gem.edit_group(42)
    #   Gitlab::Gem.edit_group(42, { name: 'Group Name' })
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the edited group.
    ...
    #
    # @example
    #   Gitlab::Gem.add_ldap_group_links(1, 'all', 50, 'ldap')
    #
    # @param  [Integer] id The ID of a group
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about added ldap group link
    ...
    #
    # @example
    #   Gitlab::Gem.delete_ldap_group_links(1, 'all')
    #
    # @param  [Integer] id The ID of a group
    # @param  [String] cn The CN of a LDAP group
    # @return [Gitlab::Gem::ObjectifiedHash] Empty hash
