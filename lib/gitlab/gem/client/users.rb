...
class Gitlab::Gem::Client
  ...
  module Users
    ...
    #
    # @example
    #   Gitlab::Gem.create_user('joe@foo.org', 'secret', 'joe', { name: 'Joe Smith' })
    #   or
    #   Gitlab::Gem.create_user('joe@foo.org', 'secret', 'joe')
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created user.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_user(15, { email: 'joe.smith@foo.org', projects_limit: 20 })
    #
    # @param  [Integer] id The ID of a user.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_user(1)
    #
    # @param [Integer] id The ID of a user.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted user.
    ...
    #
    # @example
    #   Gitlab::Gem.session('jack@example.com', 'secret12345')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_ssh_key('key title', 'key body')
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created SSH key.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_ssh_key(1)
    #
    # @param  [Integer] id The ID of a user's SSH key.
    # @param  [Hash] options A customizable set of options.
    # @option options  [Integer] :user_id id of the user to associate the key with
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted SSH key.
    ...
    #
    # @example
    #   Gitlab::Gem.add_email('email@example.com')
    #   Gitlab::Gem.add_email('email@example.com', 2)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.delete_email(2)
    #   Gitlab::Gem.delete_email(3, 2)
    #
