...
class Gitlab::Gem::Client
  ...
  module IssueLinks
    ...
    #
    # @example
    #   Gitlab::Gem.create_issue_link(6, 1, 6, 2)
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created link.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_issue_link(5, 10, 123)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] issue The ID of an issue.
