...
class Gitlab::Gem::Client
  ...
  module Runners
    ...
    # @example
    #   Gitlab::Gem.runners
    #   Gitlab::Gem.runners(:active)
    #   Gitlab::Gem.runners(:paused)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.update_runner(42, { description: 'Awesome runner' })
    #   Gitlab::Gem.update_runner(42, { active: false })
    #   Gitlab::Gem.update_runner(42, { tag_list: [ 'awesome', 'runner' ] })
    #
    # @param  [Integer, String] id The ID of a runner
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.project_enable_runner(2, 42)
    #
    # @param  [Integer, String] id The ID or name of a project.
    # @param  [Integer, String] id The ID of a runner.
    # @return <Gitlab::Gem::ObjectifiedHash>
    ...
    #
    # @example
    #   Gitlab::Gem.project_disable_runner(2, 42)
    #
    # @param  [Integer, String] id The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.register_runner('9142c16ea169eaaea3d752313a434a6e')
    #   Gitlab::Gem.register_runner('9142c16ea169eaaea3d752313a434a6e', description: 'Some Description', active: true, locked: false)
    #
    ...
    # @return <Gitlab::Gem::ObjectifiedHash> Response against runner registration
    ...
    #
    # @example
    #   Gitlab::Gem.delete_registered_runner('9142c16ea169eaaea3d752313a434a6e')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.verify_auth_registered_runner('9142c16ea169eaaea3d752313a434a6e')
    #
    # @param  [String] token Runner authentication token.
    # @return [nil] This API call returns an empty response body.
