...
class Gitlab::Gem::Client
  ...
  module GroupMilestones
    ...
    #
    # @example
    #   Gitlab::Gem.group_milestone(5, 36)
    #
    # @param  [Integer, String] id The ID or name of a group.
    ...
    #
    # @example
    #   Gitlab::Gem.create_group_milestone(5, 'v1.0')
    #
    # @param  [Integer, String] id The ID or name of a group.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created milestone.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_group_milestone(5, 2, { state_event: 'activate' })
    #
    # @param  [Integer, String] id The ID or name of a group.
    # @param  [Integer] milestone_id The ID of a milestone.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated milestone.
    ...
    #
    # @example
    #   Gitlab::Gem.group_milestone_issues(5, 2)
    #
    # @param  [Integer, String] id The ID or name of a group.
    ...
    #
    # @example
    #   Gitlab::Gem.group_milestone_merge_requests(5, 2)
    #
