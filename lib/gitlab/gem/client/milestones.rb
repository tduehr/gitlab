...
class Gitlab::Gem::Client
  ...
  module Milestones
    ...
    #
    # @example
    #   Gitlab::Gem.milestone_issues(5, 2)
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.milestone_merge_requests(5, 2)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer, String] milestone The ID of a milestone.
    # @option options [Integer] :page The page number.
    ...
    #
    # @example
    #   Gitlab::Gem.create_milestone(5, 'v1.0')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_milestone(5, 2, { state_event: 'activate' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a milestone.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_milestone(5, 2)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a milestone.
