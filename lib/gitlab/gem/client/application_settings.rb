...
class Gitlab::Gem::Client
  ...
  module ApplicationSettings
    # Retrives the application settings of Gitlab::Gem.
    #
    # @example
    #   Gitlab::Gem.application_settings
    #
    ...
    # Edit the applications settings of Gitlab::Gem.
    #
    # @example
    #   Gitlab::Gem.edit_application_settings({ signup_enabled: false })
    #
