...
class Gitlab::Gem::Client
  ...
  module ProjectReleases
    ...
    #
    # @example
    #   Gitlab::Gem.project_releases(5)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] Paginated list of Releases, sorted by created_at.
    ...
    #
    # @example
    #   Gitlab::Gem.project_release(5, 'v0.1')
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from..
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the release
    ...
    #
    # @example
    #   Gitlab::Gem.create_project_release(5, { name: 'New Release', tag_name: 'v0.3', description: 'Super nice release' })
    #   Gitlab::Gem.create_project_release(5, { name: 'New Release', tag_name: 'v0.3', description: 'Super nice release', assets: { links: [{ name: 'hoge', url: 'https://google.com' }] } })
    #
    # @param [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the created release.
    ...
    #
    # @example
    #   Gitlab::Gem.update_project_release(5, 'v0.3', { name: 'New Release', description: 'Super nice release' })
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from.
    # @param [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the updated release.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_project_release(5, 'v0.3')
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the deleted release.
