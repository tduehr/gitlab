...
class Gitlab::Gem::Client
  ...
  module ContainerRegistry
    ...
    #
    # @example
    #   Gitlab::Gem.registry_repositories(5)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] Returns list of registry repositories in a project.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_registry_repository(5, 2)
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.registry_repository_tags(5, 2)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] repository_id The ID of registry repository.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] Returns list of tags of a registry repository.
    ...
    #
    # @example
    #   Gitlab::Gem.registry_repository_tag(5, 2, 'v10.0.0')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] repository_id The ID of registry repository.
    # @param  [String] tag_name The name of tag.
    # @return <Gitlab::Gem::ObjectifiedHash> Returns details about the registry repository tag
    ...
    #
    # @example
    #   Gitlab::Gem.delete_registry_repository_tag(5, 2, 'v10.0.0')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] repository_id The ID of registry repository.
    # @param  [String] tag_name The name of tag.
    ...
    #
    # @example
    #   Gitlab::Gem.bulk_delete_registry_repository_tags(5, 2, name_regex: '.*')
    #   Gitlab::Gem.bulk_delete_registry_repository_tags(5, 2, name_regex: '[0-9a-z]{40}', keep_n: 5, older_than: '1d')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] repository_id The ID of registry repository.
