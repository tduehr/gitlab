...
class Gitlab::Gem::Client
  ...
  module ProjectBadges
    ...
    #
    # @example
    #   Gitlab::Gem.project_badges(5)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of all badges of a project
    ...
    #
    # @example
    #   Gitlab::Gem.project_badge(5, 42)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] badge_id The badge ID.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the requested badge
    ...
    #
    # @example
    #   Gitlab::Gem.add_project_badge(5, { link_url: 'https://abc.com/gitlab/gitlab-ce/commits/master', image_url: 'https://shields.io/my/badge1' })
    #
    # @param [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the added project badge.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_project_badge(5, 1, { link_url: 'https://abc.com/gitlab/gitlab-ce/commits/master', image_url: 'https://shields.io/my/badge1' })
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] badge_id The badge ID.
    # @param [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the updated project badge.
    ...
    #
    # @example
    #   Gitlab::Gem.remove_project_badge(5, 42)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] badge_id The badge ID.
    ...
    #
    # @example
    #   Gitlab::Gem.preview_project_badge(3, 'https://abc.com/gitlab/gitlab-ce/commits/master', 'https://shields.io/my/badge1')
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] :link_url URL of the badge link
    # @param [String] :image_url URL of the badge image
    # @return [Gitlab::Gem::ObjectifiedHash] Returns how the link_url and image_url final URLs would be after resolving the placeholder interpolation.
