...
class Gitlab::Gem::Client
  ...
  module ProjectReleaseLinks
    ...
    #
    # @example
    #   Gitlab::Gem.project_release_links(5, 'v0.3')
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name The tag associated with the Release.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of assets as links from a Release.
    ...
    #
    # @example
    #   Gitlab::Gem.project_release_link(5, 'v0.3', 1)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name The tag associated with the Release.
    # @param [Integer] link_id The id of the link.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the release link
    ...
    #
    # @example
    #   Gitlab::Gem.create_project_release_link(5, 'v0.1', { name: 'awesome-v0.2.dmg', url: 'http://192.168.10.15:3000' })
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name The tag associated with the Release.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the created release link.
    ...
    #
    # @example
    #   Gitlab::Gem.update_project_release_link(5, 'v0.3', 1, { name: 'awesome-v0.2.dmg', url: 'http://192.168.10.15:3000' })
    #
    # @param [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the updated release link.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_project_release_link(5, 'v0.3', 1)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from.
    # @param [Integer] link_id The id of the link.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the deleted release link.
