...
class Gitlab::Gem::Client
  ...
  module Issues
    ...
    #
    # @example
    #   Gitlab::Gem.create_issue(5, 'New issue')
    #   Gitlab::Gem.create_issue(5, 'New issue', { description: 'This is a new issue', assignee_id: 42 })
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created issue.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_issue(6, 1, { title: 'Updated title' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated issue.
    ...
    #
    # @example
    #   Gitlab::Gem.close_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about closed issue.
    ...
    #
    # @example
    #   Gitlab::Gem.reopen_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about reopened issue.
    ...
    #
    # @example
    #   Gitlab::Gem.subscribe_to_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about subscribed issue.
    ...
    #
    # @example
    #   Gitlab::Gem.unsubscribe_from_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about unsubscribed issue.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted issue.
    ...
    #
    # @example
    #   Gitlab::Gem.move_issue(3, 42, { to_project_id: '4' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    # @option options [String] :to_project_id The ID of the new project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about moved issue.
    ...
    #
    # @example
    #   Gitlab::Gem.estimate_time_of_issue(3, 42, '3h30m')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    ...
    #
    # @example
    #   Gitlab::Gem.reset_time_estimate_of_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    ...
    #
    # @example
    #   Gitlab::Gem.reset_time_spent_on_issue(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
    ...
    #
    # @example
    #   Gitlab::Gem.merge_requests_closing_issue_on_merge(3, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of an issue.
