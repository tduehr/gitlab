...
class Gitlab::Gem::Client
  ...
  module Epics
    ...
    #
    # @example
    #   Gitlab::Gem.epics(123)
    #   Gitlab::Gem.epics(123, { per_page: 40, page: 2 })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_epic(123, "My new epic title")
    #
    # @param  [Integer] group_id The ID of a group.
    # @param  [String] title
    # @param  [Hash] options A customizable set of options.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created epic.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_epic(42)
    #   Gitlab::Gem.edit_epic(42, 123, { title: 'New epic title' })
    #
    # @param  [Integer] group_id The ID.
    # @param  [Integer] epic_iid The IID of an epic.
    # @param  [Hash] options A customizable set of options
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the edited epic.
