...
class Gitlab::Gem::Client
  ...
  module Templates
    ...
    #
    # @example
    #   Gitlab::Gem.dockerfile_templates
    #
    ...
    #
    # @example
    #   Gitlab::Gem.dockerfile_template('Binary')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.gitignore_templates
    #
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.gitignore_template('Ruby')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.gitlab_ci_yml_templates
    #
    # @return [Array<Gitlab::Gem::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Gem.gitlab_ci_yml_template('Ruby')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.license_templates
    #   Gitlab::Gem.license_templates(popular: true)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.license_template('Ruby')
    #
