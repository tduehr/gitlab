...
class Gitlab::Gem::Client
  ...
  module Projects
    ...
    # (Any provided options will be passed to Gitlab::Gem. See {https://docs.gitlab.com/ce/api/projects.html#list-all-projects Gitlab docs} for all valid options)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.project_search('gitlab')
    #   Gitlab::Gem.project_search('gitlab', { order_by: 'last_activity_at' })
    #   Gitlab::Gem.search_projects('gitlab', { order_by: 'name', sort: 'asc' })
    #
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.project(3)
    #   Gitlab::Gem.project('gitlab')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_project('gitlab')
    #   Gitlab::Gem.create_project('viking', { description: 'Awesome project' })
    #   Gitlab::Gem.create_project('Red', { wall_enabled: false })
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created project.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_project(4)
    #
    # @param  [Integer, String] id The ID or path of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted project.
    ...
    #
    # @example
    #   Gitlab::Gem.team_members(42)
    #   Gitlab::Gem.team_members('gitlab')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.team_member('gitlab', 2)
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.add_team_member('gitlab', 2, 40)
    #   Gitlab::Gem.add_team_member('gitlab', 2, 40, { expires_at: "2018-12-31"})
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about added team member.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_team_member('gitlab', 3, 20)
    #   Gitlab::Gem.edit_team_member('gitlab', 3, 20, { expires_at: "2018-12-31"})
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The ID of a user.
    # @param  [Integer] access_level The access level to project.
    # @param  [Hash] options A customizable set of options.
    # @option options [String] :expires_at A date string in the format YEAR-MONTH-DAY.
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] Information about updated team member.
    ...
    #
    # @example
    #   Gitlab::Gem.remove_team_member('gitlab', 2)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The ID of a user.
    # @param  [Hash] options A customizable set of options.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about removed team member.
    ...
    #
    # @example
    #   Gitlab::Gem.project_hooks(42)
    #   Gitlab::Gem.project_hooks('gitlab')
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Hash] options A customizable set of options.
    # @option options [Integer] :page The page number.
    ...
    #
    # @example
    #   Gitlab::Gem.project_hook(42, 5)
    #   Gitlab::Gem.project_hook('gitlab', 5)
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.add_project_hook(42, 'https://api.example.net/v1/webhooks/ci')
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about added hook.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_project_hook(42, 1, 'https://api.example.net/v1/webhooks/ci')
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    # @param  option [Boolean] :merge_requests_events Trigger hook on merge_requests events (0 = false, 1 = true)
    # @param  option [Boolean] :tag_push_events Trigger hook on push_tag events (0 = false, 1 = true)
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated hook.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_project_hook('gitlab', 4)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [String] id The ID of the hook.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted hook.
    ...
    #
    # @example
    #   Gitlab::Gem.add_push_rule(42, { deny_delete_tag: false, commit_message_regex: '\\b[A-Z]{3}-[0-9]+\\b' })
    #
    # @param  [Integer] id The ID of a project.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about added push rule.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_push_rule(42, { deny_delete_tag: false, commit_message_regex: '\\b[A-Z]{3}-[0-9]+\\b' })
    #
    # @param  [Integer] id The ID of a project.
    # @param  [Hash] options A customizable set of options.
    # @param  option [Boolean] :deny_delete_tag Do not allow users to remove git tags with git push (0 = false, 1 = true)
    # @param  option [String] :commit_message_regex Commit message regex
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated push rule.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_push_rule(42)
    #
    # @param  [Integer] id The ID of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted push rule.
    ...
    #
    # @example
    #   Gitlab::Gem.make_forked(42, 24)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The ID of the project it is forked from.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the forked project.
    ...
    #
    # @example
    #   Gitlab::Gem.create_deploy_key(42, 'My Key', 'Key contents', can_push: true)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [String] title The title of a deploy key.
    # @param  [String] key The content of a deploy key.
    # @param  [Hash] options A customizable set of options.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created deploy key.
    ...
    #
    # @example
    #   Gitlab::Gem.enable_deploy_key(42, 66)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] key The ID of a deploy key.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the enabled deploy key.
    ...
    #
    # @example
    #   Gitlab::Gem.disable_deploy_key(42, 66)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] key The ID of a deploy key.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the disabled deploy key.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_deploy_key(42, 66, 'New key name', can_push: false)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The ID of a deploy key.
    # @param  [String] title The title of a deploy key.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_deploy_key(42, 1)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The ID of a deploy key.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted deploy key.
    ...
    #
    # @example
    #   Gitlab::Gem.create_fork(42)
    #   Gitlab::Gem.create_fork(42, { sudo: 'another_username' })
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_project(42)
    #   Gitlab::Gem.edit_project(42, { name: 'Project Name' })
    #   Gitlab::Gem.edit_project('project-name', { name: 'New Project Name', path: 'new-project-patth' })
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Hash] options A customizable set of options
    ...
    # (Any provided options will be passed to Gitlab::Gem. See {https://docs.gitlab.com/ce/api/projects.html#edit-project Gitlab docs} for all valid options)
    #
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the edited project.
    ...
    #
    # @example
    #   Gitlab::Gem.share_project_with_group('gitlab', 2, 40)
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.unshare_project_with_group('gitlab', 2)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The ID of a group.
    ...
    #
    # @example
    #   Gitlab::Gem.transfer_project(42, 'yolo')
    #
    # @param  [Integer, String] project The ID or path of a project
    # @param  [Integer, String] namespace The ID or path of the namespace to transfer to project to
    # @return [Gitlab::Gem::ObjectifiedHash] Information about transfered project.
    ...
    #
    # @example
    #   Gitlab::Gem.star_project(42)
    #   Gitlab::Gem.star_project('gitlab-org/gitlab-ce')
    #
    # @param  [Integer, String] id The ID or path of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about starred project.
    def star_project(id)
    ...
    #
    # @example
    #   Gitlab::Gem.unstar_project(42)
    #   Gitlab::Gem.unstar_project('gitlab-org/gitlab-ce')
    #
    # @param  [Integer, String] id The ID or path of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about unstarred project.
    ...
    #
    # @example
    #   Gitlab::Gem.user_projects(1)
    #   Gitlab::Gem.user_projects(1, { order_by: 'last_activity_at' })
    #   Gitlab::Gem.user_projects('username', { order_by: 'name', sort: 'asc' })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.upload_file(1, '/full/path/to/avatar.jpg')
    #
    # @param  [Integer, String] id The ID or path of a project.
    ...
    #
    # @example
    #   Gitlab::Gem.project_templates(1, 'dockerfiles')
    #   Gitlab::Gem.project_templates(1, 'licenses')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.project_template(1, 'dockerfiles', 'dockey')
    #   Gitlab::Gem.project_template(1, 'licenses', 'gpl', { project: 'some project', fullname: 'Holder Holding' })
    #
    ...
    #
    # @example
    #   Gitlab::Gem.archive_project(4)
    #
    # @param  [Integer, String] id The ID or path of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about archived project.
    ...
    #
    # @example
    #   Gitlab::Gem.unarchive_project(4)
    #
    # @param  [Integer, String] id The ID or path of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about unarchived project.
