...
class Gitlab::Gem::Client
  ...
  module AwardEmojis
    ...
    #
    # @example
    #   Gitlab::Gem.award_emojis(1, 80, 'issue')
    #   Gitlab::Gem.award_emojis(1, 60, 'merge_request')
    #   Gitlab::Gem.award_emojis(1, 40, 'snippet')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.note_award_emojis(1, 80, 'issue', 1)
    #   Gitlab::Gem.note_award_emojis(1, 60, 'merge_request', 1)
    #   Gitlab::Gem.note_award_emojis(1, 40, 'snippet', 1)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Gem.award_emoji(1, 80, 'issue', 4)
    #   Gitlab::Gem.award_emoji(1, 60, 'merge_request', 4)
    #   Gitlab::Gem.award_emoji(1, 40, 'snippet', 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Gem.note_award_emoji(1, 80, 'issue', 1, 4)
    #   Gitlab::Gem.note_award_emoji(1, 60, 'merge_request', 1, 4)
    #   Gitlab::Gem.note_award_emoji(1, 40, 'snippet', 1, 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Gem.create_award_emoji(1, 80, 'issue', 'blowfish')
    #   Gitlab::Gem.create_award_emoji(1, 80, 'merge_request', 'blowfish')
    #   Gitlab::Gem.create_award_emoji(1, 80, 'snippet', 'blowfish')
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Gem.create_note_award_emoji(1, 80, 'issue', 1, 'blowfish')
    #   Gitlab::Gem.create_note_award_emoji(1, 80, 'merge_request', 1, 'blowfish')
    #   Gitlab::Gem.create_note_award_emoji(1, 80, 'snippet', 1, 'blowfish')
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Gem.delete_award_emoji(1, 80, 'issue', 4)
    #   Gitlab::Gem.delete_award_emoji(1, 60, 'merge_request', 4)
    #   Gitlab::Gem.delete_award_emoji(1, 40, 'snippet', 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Gem.delete_note_award_emoji(1, 80, 'issue', 1, 4)
    #   Gitlab::Gem.delete_note_award_emoji(1, 60, 'merge_request', 1, 4)
    #   Gitlab::Gem.delete_note_award_emoji(1, 40, 'snippet', 1, 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
