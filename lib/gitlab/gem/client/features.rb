...
class Gitlab::Gem::Client
  ...
  module Features
    ...
    #
    # @example
    #   Gitlab::Gem.set_feature('new_library', true)
    #   Gitlab::Gem.set_feature('new_library', 8)
    #   Gitlab::Gem.set_feature('new_library', true, {user: 'gitlab'})
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the set/created/updated feature.
