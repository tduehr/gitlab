...
class Gitlab::Gem::Client
  ...
  module GroupLabels
    ...
    #
    # @example
    #   Gitlab::Gem.group_labels('globex')
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_group_label('globex', 'Backlog', '#DD10AA')
    #
    # @param  [Integer, String] group The ID or name of a group.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created label.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_group_label('globex', 'Backlog', { new_name: 'Priority' })
    #   Gitlab::Gem.edit_group_label('globex', 'Backlog', { new_name: 'Priority', color: '#DD10AA' })
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] name The name of a label.
    # @param  [Hash] options A customizable set of options.
    ...
    # @option options [String] :description The description of the label.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated label.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_group_label('globex', 'Backlog')
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] name The name of a label.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about deleted label.
    ...
    #
    # @example
    #   Gitlab::Gem.subscribe_to_group_label('globex', 'Backlog')
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] name The name of a label.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the label subscribed to.
    ...
    #
    # @example
    #   Gitlab::Gem.unsubscribe_from_group_label('globex', 'Backlog')
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] name The name of a label.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the label unsubscribed from.
