...
class Gitlab::Gem::Client
  ...
  module MergeRequestApprovals
    ...
    #
    # @example
    #   Gitlab::Gem.project_merge_request_approvals(1)
    #
    # @param [Integer] project The ID of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] MR approval configuration information about the project
    ...
    #
    # @example
    #    Gitlab::Gem.edit_project_merge_request_approvals(1, {approvals_before_merge: 3})
    #    Gitlab::Gem.edit_project_merge_request_approvals(1, {approvals_before_merge: 3, reset_approvals_on_push: true})
    #    Gitlab::Gem.edit_project_merge_request_approvals(1, {approvals_before_merge: 3, disable_overriding_approvers_per_merge_request: false})
    #
    ...
    #
    # @example
    #   Gitlab::Gem.project_merge_request_approval_rules(1)
    #
    # @param [Integer] project The ID of a project.
    # @return [Gitlab::Gem::ObjectifiedHash] MR approval rules for the project
    ...
    #
    # @example
    #   Gitlab::Gem.create_project_merge_request_approval_rule(1, {name: "security", approvals_required: 1})
    #
    # @param [Integer] project(required) The ID of a project.
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] New MR approval rule
    ...
    #
    # @example
    #   Gitlab::Gem.update_project_merge_request_approval_rule(1, {name: "security", approvals_required: 2})
    #
    # @param [Integer] project(required) The ID of a project.
    ...
    # @option options [Array] :group_ids(optional) The ids of groups as approvers
    # @option options [Array] :protected_branch_ids(optional) The ids of protected branches to scope the rule by
    # @return [Gitlab::Gem::ObjectifiedHash] Updated MR approval rule
    ...
    #
    # @example
    #   Gitlab::Gem.delete_project_merge_request_approval_rule(1, 1)
    #
    # @param [Integer] project(required) The ID of a project.
    ...
    #
    # @example
    #    Gitlab::Gem.edit_project_approvers(1, {approver_ids: [5], approver_groups: [1]})
    #
    # @param [Integer] project(required) The ID of a project.
    ...
    #
    # @example
    #    Gitlab::Gem.merge_request_approvals(1, 5)
    #
    # @param [Integer] project(required) The ID of a project.
    # @param [Integer] merge_request(required) The IID of a merge_request.
    # @return [Gitlab::Gem::ObjectifiedHash] MR approval configuration information about the merge request
    ...
    #
    # @example
    #    Gitlab::Gem.edit_merge_request_approvals(1, 5, approvals_required: 2)
    #
    # @param [Integer] project(required) The ID of a project.
    # @param [Integer] merge_request(required) The IID of a merge_request.
    # @option options [Integer] :approvals_required(required) Approvals required before MR can be merged
    # @return [Gitlab::Gem::ObjectifiedHash] Updated MR approval configuration information about the merge request
    ...
    #
    # @example
    #    Gitlab::Gem.edit_merge_request_approvers(1, 5, {approver_ids: [5], approver_groups: [1]})
    #
    # @param [Integer] project(required) The ID of a project.
    # @param [Integer] merge_request(required) The IID of a merge_request.
    # @option options [Array] :approver_ids(required, nil if none) An array of User IDs that can approve MRs
    ...
    #
    # @example
    #    Gitlab::Gem.approve_merge_request(1, 5)
    #    Gitlab::Gem.approve_merge_request(1, 5, sha: 'fe678da')
    #
    # @param [Integer] project(required) The ID of a project.
    ...
    #
    # @example
    #    Gitlab::Gem.unapprove_merge_request(1, 5)
    #
    # @param [Integer] project(required) The ID of a project.
    # @param [Integer] merge_request(required) The IID of a merge request.
    ...
    #
    # @example
    #   Gitlab::Gem.merge_request_approval_state(5, 36)
    #
