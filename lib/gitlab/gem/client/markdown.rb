...
class Gitlab::Gem::Client
  ...
  module Markdown
    ...
    #
    # @example
    #   Gitlab::Gem.markdown('Hello world! :tada:')
    #   Gitlab::Gem.markdown('Hello world! :tada:', gfm: true, project: 'group_example/project_example')
    #
    ...
    # @return <Gitlab::Gem::ObjectifiedHash> Returns the rendered markdown as response
