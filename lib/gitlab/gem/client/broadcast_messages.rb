...
class Gitlab::Gem::Client
  ...
  module BroadcastMessages
    ...
    #
    # @example
    #   Gitlab::Gem.broadcast_message(3)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.create_broadcast_message('Mayday')
    #   Gitlab::Gem.create_broadcast_message('Mayday', {starts_at: Time.zone.now, ends_at: Time.zone.now + 30.minutes, color: '#cecece', font: '#FFFFFF'})
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created broadcast message.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_broadcast_message(6, { message: 'No Mayday' })
    #   Gitlab::Gem.edit_broadcast_message(6, { font: '#FEFEFE' })
    #
    ...
    # @option options [String] :color(optional) Background color hex code
    # @option options [String] :font(optional) Foreground color hex code
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated broadcast message.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_broadcast_message(3)
    #
    # @param  [Integer] id The ID of a broadcast message.
