...
class Gitlab::Gem::Client
  ...
  module UserSnippets
    ...
    #
    # @example
    #   Gitlab::Gem.user_snippets
    #
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of snippets of current user
    def user_snippets
      get('/snippets')
    end
    ...
    #
    # @example
    #   Gitlab::Gem.user_snippet(1)
    #
    # @param  [Integer] id ID of snippet to retrieve.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about the user snippet
    def user_snippet(id)
      get("/snippets/#{id}")
    end
    ...
    def user_snippet_raw(id)
      get("/snippets/#{id}/raw",
          ...
          parser: ::Gitlab::Gem::Request::Parser)
    end

    # Create a new snippet.
    #
    # @example
    #   Gitlab::Gem.create_user_snippet({ title: 'REST', file_name: 'api.rb', content: 'some code', description: 'Hello World snippet', visibility: 'public'})
    #
    ...
    # @return [Gitlab::Gem::ObjectifiedHash] Information about created snippet.
    ...
    #
    # @example
    #   Gitlab::Gem.edit_user_snippet(34, { file_name: 'README.txt' })
    #   Gitlab::Gem.edit_user_snippet(34, { file_name: 'README.txt', title: 'New title' })
    #
    ...
    # @option options [String] :description (optional) Description of a snippet.
    # @option options [String] :visibility (optional) visibility of a snippet.
    # @return [Gitlab::Gem::ObjectifiedHash] Information about updated snippet.
    ...
    #
    # @example
    #   Gitlab::Gem.delete_user_snippet(14)
    #
    ...
    #
    # @example
    #   Gitlab::Gem.public_snippets
    #   Gitlab::Gem.public_snippets(per_page: 2, page: 1)
    #
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] List of all public snippets
    ...
    #
    # @example
    #   Gitlab::Gem.snippet_user_agent_details(1)
    #
    # @param  [Integer] id ID of snippet to delete.
    #
    # @return [Array<Gitlab::Gem::ObjectifiedHash>] Details of the user agent
