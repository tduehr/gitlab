...
describe Gitlab::Client do
  describe '.milestones' do
    before do
      ...
      @milestones = Gitlab::Client.milestones(3)
    end
  ...
  describe '.milestone' do
    before do
      ...
      @milestone = Gitlab::Client.milestone(3, 1)
    end
  ...
  describe '.milestone_issues' do
    before do
      ...
      @milestone_issues = Gitlab::Client.milestone_issues(3, 1)
    end
  ...
  describe '.milestone_merge_requests' do
    before do
      ...
      @milestone_merge_requests = Gitlab::Client.milestone_merge_requests(3, 1)
    end
  ...
  describe '.create_milestone' do
    before do
      ...
      @milestone = Gitlab::Client.create_milestone(3, 'title')
    end
  ...
  describe '.edit_milestone' do
    before do
      ...
      @milestone = Gitlab::Client.edit_milestone(3, 33, title: 'title')
    end
  ...
  describe '.delete_milestone' do
    before do
      ...
      @milestone = Gitlab::Client.delete_milestone(3, 33)
    end
