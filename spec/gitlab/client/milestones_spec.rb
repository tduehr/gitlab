...
describe Gitlab::Gem::Client do
  describe '.milestones' do
    before do
      ...
      @milestones = Gitlab::Gem.milestones(3)
    end
    ...
    it "returns a paginated response of project's milestones" do
      expect(@milestones).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.milestone(3, 1)
    end
  ...
  describe '.milestone_issues' do
    before do
      ...
      @milestone_issues = Gitlab::Gem.milestone_issues(3, 1)
    end
    ...
    it "returns a paginated response of milestone's issues" do
      expect(@milestone_issues).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.milestone_merge_requests' do
    before do
      ...
      @milestone_merge_requests = Gitlab::Gem.milestone_merge_requests(3, 1)
    end
    ...
    it "returns a paginated response of milestone's merge_requests" do
      expect(@milestone_merge_requests).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.create_milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.create_milestone(3, 'title')
    end
  ...
  describe '.edit_milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.edit_milestone(3, 33, title: 'title')
    end
  ...
  describe '.delete_milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.delete_milestone(3, 33)
    end
