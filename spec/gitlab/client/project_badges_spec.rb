...
describe Gitlab::Gem::Client do
  describe '.project_badges' do
    before do
      ...
      @project_badges = Gitlab::Gem.project_badges(3)
    end
    ...
    it "returns a paginated response of project's badges" do
      expect(@project_badges).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.project_badge' do
    before do
      ...
      @project_badge = Gitlab::Gem.project_badge(3, 3)
    end
  ...
  describe '.add_project_badge' do
    before do
      ...
      @project_badge = Gitlab::Gem.add_project_badge(3, link_url: 'http://example.com/ci_status.svg?project=%{project_path}&ref=%{default_branch}', image_url: 'https://shields.io/my/badge')
    end
  ...
  describe '.edit_project_badge' do
    before do
      ...
      @project_badge = Gitlab::Gem.edit_project_badge(3, 1, link_url: 'http://example.com/ci_status.svg?project=%{project_path}&ref=%{default_branch}', image_url: 'https://shields.io/my/badge')
    end
  ...
  describe '.remove_project_badge' do
    before do
      ...
      @project_badge = Gitlab::Gem.remove_project_badge(3, 3)
    end
  ...
  describe '.preview_project_badge' do
    before do
      ...
      @preview_project_badge = Gitlab::Gem.preview_project_badge(3, 'http://example.com/ci_status.svg?project=%{project_path}&ref=%{default_branch}', 'https://shields.io/my/badge')
    end
