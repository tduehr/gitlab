...
describe Gitlab::Gem::Client do
  describe '.project_releases' do
    before do
      ...
      @project_releases = Gitlab::Gem.project_releases(3)
    end
    ...
    it "returns a paginated response of project's releases" do
      expect(@project_releases).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.project_release' do
    before do
      ...
      @project_release = Gitlab::Gem.project_release(3, 'v0.1')
    end
  ...
  describe '.create_project_release' do
    context 'without asset links' do
      before do
        ...
        @project_release = Gitlab::Gem.create_project_release(5, name: 'Awesome app v0.1 alpha', tag_name: 'v0.1', description: "## CHANGELOG\r\n\r\n- Remove limit of 100 when searching repository code. !8671\r\n- Show error message when attempting to reopen an MR and there is an open MR for the same branch. !16447 (Akos Gyimesi)\r\n- Fix a bug where internal email pattern wasn't respected. !22516")
      end
  ...
  describe '.update_project_release' do
    before do
      ...
      @project_release = Gitlab::Gem.update_project_release(5, 'v0.1', name: 'Awesome app v0.1 alpha')
    end
  ...
  describe '.delete_project_release' do
    before do
      ...
      @project_release = Gitlab::Gem.delete_project_release(3, 'v0.1')
    end
