...
describe Gitlab::Client do
  describe '.pipelines' do
    before do
      ...
      @pipelines = Gitlab::Client.pipelines(3)
    end
  ...
  describe '.pipeline' do
    before do
      ...
      @pipeline = Gitlab::Client.pipeline(3, 46)
    end
  ...
  describe '.pipeline_test_report' do
    before do
      ...
      @report = Gitlab::Client.pipeline_test_report(3, 46)
    end
  ...
  describe '.create_pipeline' do
    ...
    before do
      ...
      @pipeline_create = Gitlab::Client.create_pipeline(3, 'master')
    end
    ...
    context 'when variables are passed' do
      before do
        ...
        @pipeline_create = Gitlab::Client.create_pipeline(3, 'master', variables)
      end
  ...
  describe '.cancel_pipeline' do
    before do
      ...
      @pipeline_cancel = Gitlab::Client.cancel_pipeline(3, 46)
    end
  ...
  describe '.retry_pipeline' do
    before do
      ...
      @pipeline_retry = Gitlab::Client.retry_pipeline(3, 46)
    end
  ...
  describe '.delete_pipeline' do
    before do
      ...
      Gitlab::Client.delete_pipeline(3, 46)
    end
