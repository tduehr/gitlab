...
describe Gitlab::Client do
  ...
  describe '.create_tag' do
    context 'when lightweight' do
      before do
        ...
        @tag = Gitlab::Client.create_tag(3, 'v1.0.0', '2695effb5807a22ff3d138d593fd856244e155e7')
      end
    ...
    context 'when annotated' do
      before do
        ...
        @tag = Gitlab::Client.create_tag(3, 'v1.1.0', '2695effb5807a22ff3d138d593fd856244e155e7', 'Release 1.1.0')
      end
  ...
  describe '.compare' do
    before do
      ...
      @diff = Gitlab::Client.compare(3, 'master', 'feature')
    end
  ...
  describe '.merge_base' do
    before do
      ...
      @response = Gitlab::Client.merge_base(3, %w[master feature])
    end
...
describe '.contributors' do
  before do
    ...
    @contributors = Gitlab::Client.contributors(3)
  end
