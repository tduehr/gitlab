...
describe Gitlab::Client do
  describe '.sidekiq_queue_metrics' do
    before do
      ...
      @sidekiq_queue_metrics = Gitlab::Client.sidekiq_queue_metrics
    end
  ...
  describe '.sidekiq_process_metrics' do
    before do
      ...
      @sidekiq_process_metrics = Gitlab::Client.sidekiq_process_metrics
    end
  ...
  describe '.sidekiq_job_stats' do
    before do
      ...
      @sidekiq_job_stats = Gitlab::Client.sidekiq_job_stats
    end
  ...
  describe '.sidekiq_compound_metrics' do
    before do
      ...
      @sidekiq_compound_metrics = Gitlab::Client.sidekiq_compound_metrics
    end
