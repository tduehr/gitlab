...
describe Gitlab::Client do
  describe '.service' do
    before do
      ...
      @service = Gitlab::Client.service(3, :redmine)
    end
  ...
  describe '.change_service' do
    before do
      ...
      @service = Gitlab::Client.change_service(3, :redmine, new_issue_url: 'https://example.com/projects/test_project/issues/new',
  ...
  describe '.delete_servoce' do
    before do
      ...
      @service = Gitlab::Client.delete_service(3, :redmine)
    end
