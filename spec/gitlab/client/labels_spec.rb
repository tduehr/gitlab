...
describe Gitlab::Client do
  ...
  describe '.delete' do
    before do
      ...
      @label = Gitlab::Client.delete_label(3, 'Backlog')
    end
  ...
  describe '.edit_label' do
    before do
      ...
      @label = Gitlab::Client.edit_label(3, 'TODO', new_name: 'Backlog')
    end
  ...
  describe '.create_label' do
    before do
      ...
      @label = Gitlab::Client.create_label(3, 'Backlog', '#DD10AA')
    end
  ...
  describe '.subscribe_to_label' do
    before do
      ...
      @label = Gitlab::Client.subscribe_to_label(3, 'Backlog')
    end
  ...
  describe '.unsubscribe_from_label' do
    before do
      ...
      @label = Gitlab::Client.unsubscribe_from_label(3, 'Backlog')
    end
