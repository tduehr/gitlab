...
describe Gitlab::Gem::Client do
  describe '.deployments' do
    before do
      ...
      @deployments = Gitlab::Gem.deployments(3)
    end
    ...
    it "returns a paginated response of project's deployments" do
      expect(@deployments).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.deployment' do
    before do
      ...
      @deployment = Gitlab::Gem.deployment(3, 42)
    end
    ...
    it 'returns a single deployment' do
      expect(@deployment).to be_a Gitlab::Gem::ObjectifiedHash
    end
