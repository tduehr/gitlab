...
describe Gitlab::Client do
  describe '.project_release_links' do
    before do
      ...
      @project_release_links = Gitlab::Client.project_release_links(3, 'v0.1')
    end
  ...
  describe '.project_release_link' do
    before do
      ...
      @project_release_link = Gitlab::Client.project_release_link(3, 'v0.1', 1)
    end
  ...
  describe '.create_project_release_link' do
    before do
      ...
      @project_release_link = Gitlab::Client.create_project_release_link(5, 'v0.1', name: 'awesome-v0.2.dmg', url: 'http://192.168.10.15:3000')
    end
  ...
  describe '.update_project_release_link' do
    before do
      ...
      @project_release_link = Gitlab::Client.update_project_release_link(5, 'v0.1', 1, url: 'http://192.168.10.15:3000')
    end
  ...
  describe '.delete_project_release_link' do
    before do
      ...
      @project_release_link = Gitlab::Client.delete_project_release_link(3, 'v0.1', 1)
    end
