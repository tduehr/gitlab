...
describe Gitlab::Client do
  describe '.user_snippets' do
    before do
      ...
      @snippets = Gitlab::Client.user_snippets
    end
  ...
  describe '.user_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.user_snippet(1)
    end
  ...
  describe '.user_snippet_raw' do
    before do
      ...
      @snippet_content = Gitlab::Client.user_snippet_raw(1)
    end
  ...
  describe '.create_user_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.create_user_snippet(title: 'This is a snippet', content: 'Hello world', description: 'Hello World snippet', file_name: 'test.txt', visibility: 'internal')
    end
  ...
  describe '.edit_user_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.edit_user_snippet(1, file_name: 'add.rb')
    end
  ...
  describe '.delete_user_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.delete_user_snippet(1)
    end
  ...
  describe '.public_snippets' do
    before do
      ...
      @snippets = Gitlab::Client.public_snippets(per_page: 2, page: 1)
    end
  ...
  describe '.snippet_user_agent_details' do
    before do
      ...
      @detail = Gitlab::Client.snippet_user_agent_details(1)
    end
