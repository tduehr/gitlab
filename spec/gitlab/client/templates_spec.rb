...
describe Gitlab::Gem::Client do
  describe '.dockerfile_templates' do
    before do
      ...
      @dockerfile_templates = Gitlab::Gem.dockerfile_templates
    end
    ...
    it 'returns a paginated response of dockerfile templates' do
      expect(@dockerfile_templates).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.dockerfile_template' do
    before do
      ...
      @dockerfile_template = Gitlab::Gem.dockerfile_template('Binary')
    end
  ...
  describe '.gitignore_templates' do
    before do
      ...
      @gitignore_templates = Gitlab::Gem.gitignore_templates
    end
    ...
    it 'returns a paginated response of gitignore templates' do
      expect(@gitignore_templates).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.gitignore_template' do
    before do
      ...
      @gitignore_template = Gitlab::Gem.gitignore_template('Ruby')
    end
  ...
  describe '.gitlab_ci_yml_templates' do
    before do
      ...
      @gitlab_ci_yml_templates = Gitlab::Gem.gitlab_ci_yml_templates
    end
    ...
    it 'returns a paginated response of gitlab_ci_yml templates' do
      expect(@gitlab_ci_yml_templates).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.gitlab_ci_yml_template' do
    before do
      ...
      @gitlab_ci_yml_template = Gitlab::Gem.gitlab_ci_yml_template('Ruby')
    end
  ...
  describe '.license_templates' do
    before do
      ...
      @license_templates = Gitlab::Gem.license_templates
    end
    ...
    it 'returns a paginated response of license templates' do
      expect(@license_templates).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.license_template' do
    before do
      ...
      @license_template = Gitlab::Gem.license_template('mit')
    end
