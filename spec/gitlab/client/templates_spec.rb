...
describe Gitlab::Client do
  describe '.dockerfile_templates' do
    before do
      ...
      @dockerfile_templates = Gitlab::Client.dockerfile_templates
    end
  ...
  describe '.dockerfile_template' do
    before do
      ...
      @dockerfile_template = Gitlab::Client.dockerfile_template('Binary')
    end
  ...
  describe '.gitignore_templates' do
    before do
      ...
      @gitignore_templates = Gitlab::Client.gitignore_templates
    end
  ...
  describe '.gitignore_template' do
    before do
      ...
      @gitignore_template = Gitlab::Client.gitignore_template('Ruby')
    end
  ...
  describe '.gitlab_ci_yml_templates' do
    before do
      ...
      @gitlab_ci_yml_templates = Gitlab::Client.gitlab_ci_yml_templates
    end
  ...
  describe '.gitlab_ci_yml_template' do
    before do
      ...
      @gitlab_ci_yml_template = Gitlab::Client.gitlab_ci_yml_template('Ruby')
    end
  ...
  describe '.license_templates' do
    before do
      ...
      @license_templates = Gitlab::Client.license_templates
    end
  ...
  describe '.license_template' do
    before do
      ...
      @license_template = Gitlab::Client.license_template('mit')
    end
