...
describe Gitlab::Client do
  ...
  describe '.branches' do
    before do
      ...
      @branches = Gitlab::Client.branches(3)
    end
  ...
  describe '.branch' do
    before do
      ...
      @branch = Gitlab::Client.branch(3, 'api')
    end
  ...
  describe '.protect_branch' do
    ...
    context 'without options' do
      before do
        @branch = Gitlab::Client.protect_branch(3, 'api')
      end
    ...
    context 'with options' do
      before do
        @branch = Gitlab::Client.protect_branch(3, 'api', developers_can_push: true)
      end
  ...
  describe '.unprotect_branch' do
    before do
      ...
      @branch = Gitlab::Client.unprotect_branch(3, 'api')
    end
  ...
  describe '.create_branch' do
    before do
      ...
      @branch = Gitlab::Client.create_branch(3, 'api', 'master')
    end
  ...
  describe '.delete_branch' do
    before do
      ...
      @branch = Gitlab::Client.delete_branch(3, 'api')
    end
  ...
  describe '.delete_merged_branches' do
    before do
      ...
      @branch = Gitlab::Client.delete_merged_branches(3)
    end
  ...
  describe '.protected_branches' do
    before do
      ...
      @branches = Gitlab::Client.protected_branches(3)
    end
  ...
  describe '.protected_branch' do
    before do
      ...
      @branch = Gitlab::Client.protected_branch(3, 'master')
    end
