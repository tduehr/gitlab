...
describe Gitlab::Client do
  ...
  describe '.tag' do
    ...
    context 'tag with special character' do
      before do
        ...
        @tag = Gitlab::Client.tag(3, 'test/me')
      end
  ...
  describe '.create_tag' do
    before do
      ...
      @tag = Gitlab::Client.create_tag(3, '0.0.1', 'master', 'this tag is annotated', 'and it has release notes')
    end
  ...
  describe '.delete_tag' do
    before do
      ...
      @tag = Gitlab::Client.delete_tag(3, '0.0.1')
    end
    ...
    context 'tag with special character' do
      before do
        ...
        @tag = Gitlab::Client.delete_tag(3, 'test/me')
      end
  ...
  describe '.create_release' do
    before do
      ...
      @tag = Gitlab::Client.create_release(3, '0.0.1', 'Amazing release. Wow')
    end
    ...
    context 'tag with special character' do
      before do
        ...
        @tag = Gitlab::Client.create_release(3, 'test/me', 'Amazing release. Wow')
      end
  ...
  describe '.update_release' do
    before do
      ...
      @tag = Gitlab::Client.update_release(3, '0.0.1', 'Amazing release. Wow')
    end
    ...
    context 'tag with special character' do
      before do
        ...
        @tag = Gitlab::Client.update_release(3, 'test/me', 'Amazing release. Wow')
      end
