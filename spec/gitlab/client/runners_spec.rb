...
describe Gitlab::Client do
  describe '.runners' do
    ...
    context 'with queries' do
      before do
        ...
        @runner = Gitlab::Client.runners(type: :instance_type)
      end
  ...
  describe '.all_runners' do
    ...
    context 'without extra queries' do
      before do
        @runner = Gitlab::Client.all_runners
      end
    ...
    context 'with queries' do
      before do
        ...
        @runner = Gitlab::Client.all_runners(type: :instance_type)
      end
  ...
  describe '.runner' do
    before do
      ...
      @runners = Gitlab::Client.runner(6)
    end
  ...
  describe '.update_runner' do
    before do
      ...
      @runner = Gitlab::Client.update_runner(6, description: 'abcefg')
    end
  ...
  describe '.delete_runner' do
    before do
      ...
      @runner = Gitlab::Client.delete_runner(6)
    end
  ...
  describe '.runner_jobs' do
    before do
      ...
      @jobs = Gitlab::Client.runner_jobs(1, status: :running)
    end
  ...
  describe '.project_runners' do
    before do
      ...
      @runners = Gitlab::Client.project_runners(1)
    end
  ...
  describe '.project_enable_runner' do
    before do
      ...
      @runner = Gitlab::Client.project_enable_runner(1, 6)
    end
  ...
  describe '.project_disable_runner' do
    before do
      ...
      @runner = Gitlab::Client.project_disable_runner(1, 6)
    end
  ...
  describe '.group_runners' do
    ...
    context 'without extra queries' do
      before do
        @runners = Gitlab::Client.group_runners(9)
      end
    ...
    context 'with queries' do
      before do
        ...
        @runner = Gitlab::Client.group_runners(9, type: :instance_type)
      end
  ...
  describe '.register_runner' do
    before do
      ...
      @register_runner_response = Gitlab::Client.register_runner('6337ff461c94fd3fa32ba3b1ff4125', description: 'Some Description', active: true, locked: false)
    end
  ...
  describe '.delete_registered_runner' do
    before do
      ...
      Gitlab::Client.delete_registered_runner('6337ff461c94fd3fa32ba3b1ff4125')
    end
  ...
  describe '.verify_auth_registered_runner' do
    before do
      ...
      Gitlab::Client.verify_auth_registered_runner('6337ff461c94fd3fa32ba3b1ff4125')
    end
