...
describe Gitlab::Gem::Client do
  describe '.runners' do
    ...
    context 'without scope' do
      ...
      it 'returns a paginated response of runners' do
        expect(@runner).to be_a Gitlab::Gem::PaginatedResponse
    ...
    context 'with scope' do
      before do
        ...
        @runner = Gitlab::Gem.runners(scope: :online)
      end
  ...
  describe '.all_runners' do
    ...
    context 'with scope' do
      before do
        ...
        @runner = Gitlab::Gem.all_runners(scope: :online)
      end
  ...
  describe '.runner' do
    ...
    it 'returns a response of a runner' do
      expect(@runners).to be_a Gitlab::Gem::ObjectifiedHash
  ...
  describe '.update_runner' do
    before do
      ...
      @runner = Gitlab::Gem.update_runner(6, description: 'abcefg')
    end
    ...
    it 'returns an updated response of a runner' do
      expect(@runner).to be_a Gitlab::Gem::ObjectifiedHash
  ...
  describe '.delete_runner' do
    before do
      ...
      @runner = Gitlab::Gem.delete_runner(6)
    end
  ...
  describe '.runner_jobs' do
    before do
      ...
      @jobs = Gitlab::Gem.runner_jobs(1, status: :running)
    end
  ...
  describe '.project_runners' do
    before do
      ...
      @runners = Gitlab::Gem.project_runners(1)
    end
    ...
    it 'returns a paginated response of runners' do
      expect(@runners).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.project_enable_runner' do
    before do
      ...
      @runner = Gitlab::Gem.project_enable_runner(1, 6)
    end
  ...
  describe '.project_disable_runner' do
    before do
      ...
      @runner = Gitlab::Gem.project_disable_runner(1, 6)
    end
  ...
  describe '.register_runner' do
    before do
      ...
      @register_runner_response = Gitlab::Gem.register_runner('6337ff461c94fd3fa32ba3b1ff4125', description: 'Some Description', active: true, locked: false)
    end
  ...
  describe '.delete_registered_runner' do
    before do
      ...
      Gitlab::Gem.delete_registered_runner('6337ff461c94fd3fa32ba3b1ff4125')
    end
  ...
  describe '.verify_auth_registered_runner' do
    before do
      ...
      Gitlab::Gem.verify_auth_registered_runner('6337ff461c94fd3fa32ba3b1ff4125')
    end
