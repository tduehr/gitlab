...
describe Gitlab::Client do
  describe '.project_access_requests' do
    before do
      ...
      @access_requests = Gitlab::Client.project_access_requests(1)
    end
  ...
  describe '.group_access_requests' do
    before do
      ...
      @access_requests = Gitlab::Client.group_access_requests(1)
    end
  ...
  describe '.request_project_access' do
    before do
      ...
      @access_request = Gitlab::Client.request_project_access(1)
    end
  ...
  describe '.request_group_access' do
    before do
      ...
      @access_request = Gitlab::Client.request_group_access(1)
    end
  ...
  describe '.approve_project_access_request' do
    context 'When no access level is given' do
      before do
        ...
        @access_request = Gitlab::Client.approve_project_access_request(1, 1)
      end
    ...
    context 'When access level is given' do
      before do
        ...
        @access_request = Gitlab::Client.approve_project_access_request(1, 1, access_level: '20')
      end
  ...
  describe '.approve_group_access_request' do
    context 'When no access level is given' do
      before do
        ...
        @access_request = Gitlab::Client.approve_group_access_request(1, 1)
      end
    ...
    context 'When access level is given' do
      before do
        ...
        @access_request = Gitlab::Client.approve_group_access_request(1, 1, access_level: '20')
      end
  ...
  describe '.deny_project_access_request' do
    before do
      ...
      @access_request = Gitlab::Client.deny_project_access_request(1, 1)
    end
  ...
  describe '.deny_group_access_request' do
    before do
      ...
      @access_request = Gitlab::Client.deny_group_access_request(1, 1)
    end
