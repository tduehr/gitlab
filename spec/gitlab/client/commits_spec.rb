...
describe Gitlab::Client do
  ...
  describe '.commits' do
    before do
      stub_get('/projects/3/repository/commits', 'project_commits')
        .with(query: { ref: 'api' })
      @commits = Gitlab::Client.commits(3, ref: 'api')
    end
  ...
  describe '.commit' do
    before do
      ...
      @commit = Gitlab::Client.commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    end
  ...
  describe '.commit_refs' do
    before do
      ...
      @refs = Gitlab::Client.commit_refs(3, '0b4cd14ccc6a5c392526df719d29baf4315a4bbb')
    end
  ...
  describe '.cherry_pick_commit' do
    context 'on success' do
      before do
        ...
        @cherry_pick_commit = Gitlab::Client.cherry_pick_commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master')
      end
    ...
    context 'on failure' do
      it 'includes the error_code' do
        ...
        expect { Gitlab::Client.cherry_pick_commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master') }.to raise_error(Gitlab::Client::Error::BadRequest) do |ex|
    ...
    context 'with additional options' do
      it 'passes additional options' do
        ...
        Gitlab::Client.cherry_pick_commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master', dry_run: true)
  ...
  describe '.revert_commit' do
    context 'on success' do
      before do
        ...
        @revert_commit = Gitlab::Client.revert_commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master')
      end
    ...
    context 'on failure' do
      it 'includes the error_code' do
        ...
        expect { Gitlab::Client.revert_commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master') }.to raise_error(Gitlab::Client::Error::BadRequest) do |ex|
    ...
    context 'with additional options' do
      it 'passes additional options' do
        ...
        Gitlab::Client.revert_commit(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'master', dry_run: true)
  ...
  describe '.commit_diff' do
    before do
      ...
      @diff = Gitlab::Client.commit_diff(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    end
  ...
  describe '.commit_comments' do
    before do
      ...
      @commit_comments = Gitlab::Client.commit_comments(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    end
  ...
  describe '.create_commit_comment' do
    before do
      ...
      @merge_request = Gitlab::Client.create_commit_comment(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6', 'Nice code!')
    end
  ...
  describe '.commit_status' do
    before do
      stub_get('/projects/6/repository/commits/7d938cb8ac15788d71f4b67c035515a160ea76d8/statuses', 'project_commit_status')
        .with(query: { all: 'true' })
      @statuses = Gitlab::Client.commit_status(6, '7d938cb8ac15788d71f4b67c035515a160ea76d8', all: true)
    end
  ...
  describe '.update_commit_status' do
    before do
      ...
      @status = Gitlab::Client.update_commit_status(6, '7d938cb8ac15788d71f4b67c035515a160ea76d8', 'failed', name: 'test', ref: 'decreased-spec')
    end
  ...
  describe '.create_commit' do
    ...
    before do
      ...
      @commit = Gitlab::Client.create_commit(6, 'dev', 'refactors everything', actions, author_email: 'joe@sample.org', author_name: 'Joe Sample')
    end
  ...
  describe '.repo_commit_merge_requests' do
    before do
      ...
      @commit_merge_requests = Gitlab::Client.commit_merge_requests(3, '6104942438c14ec7bd21c6cd5bd995272b3faff6')
    end
