...
describe Gitlab::Client do
  ...
  describe '.create_board' do
    before do
      ...
      @board = Gitlab::Client.create_board(5, 'project issue board')
    end
  ...
  describe '.edit_board' do
    before do
      ...
      @board = Gitlab::Client.edit_board(5, 1, name: 'new_name', milestone_id: 43, assignee_id: 1)
    end
  ...
  describe '.board_lists' do
    before do
      ...
      @board_lists = Gitlab::Client.board_lists(3, 1)
    end
  ...
  describe '.board_list' do
    before do
      ...
      @board_list = Gitlab::Client.board_list(3, 1, 1)
    end
  ...
  describe '.create_board_list' do
    before do
      ...
      @board_list = Gitlab::Client.create_board_list(3, 1, 4)
    end
  ...
  describe '.edit_board_list' do
    before do
      ...
      @board_list = Gitlab::Client.edit_board_list(3, 1, 1, 3)
    end
  ...
  describe '.delete_board_list' do
    before do
      ...
      @board_list = Gitlab::Client.delete_board_list(3, 1, 1)
    end
