...
describe Gitlab::Gem::Client do
  describe '.registry_repositories' do
    before do
      ...
      @registry_repositories = Gitlab::Gem.registry_repositories(3)
    end
    ...
    it "returns a paginated response of project's registry repositories" do
      expect(@registry_repositories).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.delete_registry_repository' do
    before do
      ...
      Gitlab::Gem.delete_registry_repository(3, 1)
    end
  ...
  describe '.registry_repository_tags' do
    before do
      ...
      @registry_repository_tags = Gitlab::Gem.registry_repository_tags(3, 1)
    end
    ...
    it "returns a paginated response of a registry repository's tags" do
      expect(@registry_repository_tags).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.registry_repository_tag' do
    before do
      ...
      @registry_repository_tag = Gitlab::Gem.registry_repository_tag(3, 1, 'v10.0.0')
    end
  ...
  describe '.delete_registry_repository_tag' do
    before do
      ...
      Gitlab::Gem.delete_registry_repository_tag(3, 1, 'v10.0.0')
    end
  ...
  describe '.bulk_delete_registry_repository_tags' do
    context 'when just name_regex provided for deletion' do
      before do
        ...
        Gitlab::Gem.bulk_delete_registry_repository_tags(3, 1, name_regex: '.*')
      end
    ...
    context 'when all options provided for deletion' do
      before do
        ...
        Gitlab::Gem.bulk_delete_registry_repository_tags(3, 1, name_regex: '[0-9a-z]{40}', keep_n: 5, older_than: '1d')
      end
