...
describe Gitlab::Gem::Client do
  describe '.issues' do
    ...
    context 'with literal project ID passed' do
      before do
        ...
        @issues = Gitlab::Gem.issues('gitlab-org/gitlab-ce')
      end
  ...
  describe '.create_issue' do
    before do
      ...
      @issue = Gitlab::Gem.create_issue(3, 'title')
    end
  ...
  describe '.edit_issue' do
    before do
      ...
      @issue = Gitlab::Gem.edit_issue(3, 33, title: 'title')
    end
  ...
  describe '.close_issue' do
    before do
      stub_put('/projects/3/issues/33', 'issue')
      @issue = Gitlab::Gem.close_issue(3, 33)
    end
  ...
  describe '.reopen_issue' do
    before do
      stub_put('/projects/3/issues/33', 'issue')
      @issue = Gitlab::Gem.reopen_issue(3, 33)
    end
  ...
  describe '.subscribe_to_issue' do
    before do
      ...
      @issue = Gitlab::Gem.subscribe_to_issue(3, 33)
    end
  ...
  describe '.unsubscribe_from_issue' do
    before do
      ...
      @issue = Gitlab::Gem.unsubscribe_from_issue(3, 33)
    end
  ...
  describe '.delete_issue' do
    before do
      ...
      @issue = Gitlab::Gem.delete_issue(3, 33)
    end
  ...
  describe '.move_issue' do
    before do
      ...
      @issue = Gitlab::Gem.move_issue(3, 33, to_project_id: '4')
    end
  ...
  describe '.estimate_time_of_issue' do
    before do
      ...
      @issue = Gitlab::Gem.estimate_time_of_issue(3, 33, '3h30m')
    end
  ...
  describe '.reset_time_estimate_of_issue' do
    before do
      ...
      @issue = Gitlab::Gem.reset_time_estimate_of_issue(3, 33)
    end
  ...
  describe '.add_time_spent_on_issue' do
    context 'with positive value' do
      before do
        ...
        @issue = Gitlab::Gem.add_time_spent_on_issue(3, 33, '3h30m')
      end
    ...
    context 'with negative value' do
      before do
        stub_post('/projects/3/issues/33/add_spent_time', 'issue')
        @issue = Gitlab::Gem.add_time_spent_on_issue(3, 33, '-30m')
      end
  ...
  describe '.reset_time_spent_on_issue' do
    before do
      ...
      @issue = Gitlab::Gem.reset_time_spent_on_issue(3, 33)
    end
  ...
  describe '.time_stats_for_issue' do
    before do
      ...
      @issue = Gitlab::Gem.time_stats_for_issue(3, 33)
    end
  ...
  describe '.participants_on_issue' do
    before do
      ...
      @participants = Gitlab::Gem.participants_on_issue(3, 33)
    end
  ...
  describe '.merge_requests_closing_issue_on_merge' do
    before do
      ...
      @merge_requests = Gitlab::Gem.merge_requests_closing_issue_on_merge(3, 33)
    end
