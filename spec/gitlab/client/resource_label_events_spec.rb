...
describe Gitlab::Client do
  describe '.issue_label_events' do
    before do
      ...
      @events = Gitlab::Client.issue_label_events(5, 42)
    end
  ...
  describe '.issue_label_event' do
    before do
      ...
      @event = Gitlab::Client.issue_label_event(5, 42, 142)
    end
  ...
  describe '.epic_label_events' do
    before do
      ...
      @events = Gitlab::Client.epic_label_events(5, 42)
    end
  ...
  describe '.epic_label_event' do
    before do
      ...
      @event = Gitlab::Client.epic_label_event(5, 42, 142)
    end
  ...
  describe '.merge_request_label_events' do
    before do
      ...
      @events = Gitlab::Client.merge_request_label_events(5, 42)
    end
  ...
  describe '.merge_request_label_event' do
    before do
      ...
      @event = Gitlab::Client.merge_request_label_event(5, 42, 142)
    end
