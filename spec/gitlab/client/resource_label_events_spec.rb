...
describe Gitlab::Gem::Client do
  describe '.issue_label_events' do
    before do
      ...
      @events = Gitlab::Gem.issue_label_events(5, 42)
    end
  ...
  describe '.issue_label_event' do
    before do
      ...
      @event = Gitlab::Gem.issue_label_event(5, 42, 142)
    end
    ...
    it "returns a paginated response of project's issue's label event" do
      expect(@event).to be_a Gitlab::Gem::ObjectifiedHash
  ...
  describe '.epic_label_events' do
    before do
      ...
      @events = Gitlab::Gem.epic_label_events(5, 42)
    end
  ...
  describe '.epic_label_event' do
    before do
      ...
      @event = Gitlab::Gem.epic_label_event(5, 42, 142)
    end
  ...
  describe '.merge_request_label_events' do
    before do
      ...
      @events = Gitlab::Gem.merge_request_label_events(5, 42)
    end
  ...
  describe '.merge_request_label_event' do
    before do
      ...
      @event = Gitlab::Gem.merge_request_label_event(5, 42, 142)
    end
