...
describe Gitlab::Gem::Client do
  describe '.group_boards' do
    before do
      ...
      @group_boards = Gitlab::Gem.group_boards(5)
    end
    ...
    it "returns a paginated response of group's boards" do
      expect(@group_boards).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.group_board' do
    before do
      ...
      @group_board = Gitlab::Gem.group_board(5, 1)
    end
  ...
  describe '.create_group_board' do
    before do
      ...
      @group_board = Gitlab::Gem.create_group_board(5, 'group issue board')
    end
  ...
  describe '.edit_group_board' do
    before do
      ...
      @group_board = Gitlab::Gem.edit_group_board(5, 1, assignee_id: 1, milestone_id: 44)
    end
  ...
  describe '.group_board_lists' do
    before do
      ...
      @group_board_lists = Gitlab::Gem.group_board_lists(5, 1)
    end
    ...
    it "returns a paginated response of group's board lists" do
      expect(@group_board_lists).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.group_board_list' do
    before do
      ...
      @group_board_list = Gitlab::Gem.group_board_list(5, 1, 1)
    end
  ...
  describe '.create_group_board_list' do
    before do
      ...
      @group_board_list = Gitlab::Gem.create_group_board_list(5, 1, 5)
    end
  ...
  describe '.edit_group_board_list' do
    before do
      ...
      @group_board_list = Gitlab::Gem.edit_group_board_list(5, 1, 1, position: 1)
    end
