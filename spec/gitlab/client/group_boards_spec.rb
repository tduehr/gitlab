...
describe Gitlab::Client do
  describe '.group_boards' do
    before do
      ...
      @group_boards = Gitlab::Client.group_boards(5)
    end
  ...
  describe '.group_board' do
    before do
      ...
      @group_board = Gitlab::Client.group_board(5, 1)
    end
  ...
  describe '.create_group_board' do
    before do
      ...
      @group_board = Gitlab::Client.create_group_board(5, 'group issue board')
    end
  ...
  describe '.edit_group_board' do
    before do
      ...
      @group_board = Gitlab::Client.edit_group_board(5, 1, assignee_id: 1, milestone_id: 44)
    end
  ...
  describe '.group_board_lists' do
    before do
      ...
      @group_board_lists = Gitlab::Client.group_board_lists(5, 1)
    end
  ...
  describe '.group_board_list' do
    before do
      ...
      @group_board_list = Gitlab::Client.group_board_list(5, 1, 1)
    end
  ...
  describe '.create_group_board_list' do
    before do
      ...
      @group_board_list = Gitlab::Client.create_group_board_list(5, 1, 5)
    end
  ...
  describe '.edit_group_board_list' do
    before do
      ...
      @group_board_list = Gitlab::Client.edit_group_board_list(5, 1, 1, position: 1)
    end
