...
describe Gitlab::Client do
  ...
  describe '.triggers' do
    before do
      ...
      @triggers = Gitlab::Client.triggers(3)
    end
  ...
  describe '.trigger' do
    before do
      ...
      @trigger = Gitlab::Client.trigger(3, 10)
    end
  ...
  describe '.create_trigger' do
    before do
      ...
      @trigger = Gitlab::Client.create_trigger(3, 'my description')
    end
  ...
  describe '.update_trigger' do
    before do
      ...
      @trigger = Gitlab::Client.update_trigger(3, 1, description: 'my description')
    end
  ...
  describe '.trigger_take_ownership' do
    before do
      ...
      @trigger = Gitlab::Client.trigger_take_ownership(3, 1)
    end
  ...
  describe '.remove_trigger' do
    before do
      ...
      @trigger = Gitlab::Client.remove_trigger(3, 10)
    end
  ...
  describe '.run_trigger' do
    before do
      stub_request(:post, "#{Gitlab::Client.endpoint}/projects/3/trigger/pipeline")
    ...
    context 'when private_token is not set' do
      ...
      it 'does not raise Error::MissingCredentials' do
        expect { Gitlab::Client.run_trigger(3, '7b9148c158980bbd9bcea92c17522d', 'master', a: 10) }.not_to raise_error
      end
    end

    context 'without variables' do
      before do
        @trigger = Gitlab::Client.run_trigger(3, '7b9148c158980bbd9bcea92c17522d', 'master')
      end

      it 'gets the correct resource' do
        expect(a_request(:post, "#{Gitlab::Client.endpoint}/projects/3/trigger/pipeline")
          .with(body: {
    ...
    context 'with variables' do
      before do
        @trigger = Gitlab::Client.run_trigger(3, '7b9148c158980bbd9bcea92c17522d', 'master', a: 10)
      end
