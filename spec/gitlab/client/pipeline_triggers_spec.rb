...
describe Gitlab::Gem::Client do
  ...
  describe '.triggers' do
    before do
      ...
      @triggers = Gitlab::Gem.triggers(3)
    end
    ...
    it "returns an array of project's triggers" do
      expect(@triggers).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.trigger' do
    before do
      ...
      @trigger = Gitlab::Gem.trigger(3, 10)
    end
  ...
  describe '.create_trigger' do
    before do
      ...
      @trigger = Gitlab::Gem.create_trigger(3, 'my description')
    end
  ...
  describe '.update_trigger' do
    before do
      ...
      @trigger = Gitlab::Gem.update_trigger(3, 1, description: 'my description')
    end
  ...
  describe '.trigger_take_ownership' do
    before do
      ...
      @trigger = Gitlab::Gem.trigger_take_ownership(3, 1)
    end
  ...
  describe '.remove_trigger' do
    before do
      ...
      @trigger = Gitlab::Gem.remove_trigger(3, 10)
    end
  ...
  describe '.run_trigger' do
    before do
      stub_request(:post, "#{Gitlab::Gem.endpoint}/projects/3/trigger/pipeline")
    ...
    context 'when private_token is not set' do
      ...
      it 'does not raise Error::MissingCredentials' do
        expect { Gitlab::Gem.run_trigger(3, '7b9148c158980bbd9bcea92c17522d', 'master', a: 10) }.not_to raise_error
      end
    end

    context 'without variables' do
      before do
        @trigger = Gitlab::Gem.run_trigger(3, '7b9148c158980bbd9bcea92c17522d', 'master')
      end

      it 'gets the correct resource' do
        expect(a_request(:post, "#{Gitlab::Gem.endpoint}/projects/3/trigger/pipeline")
          .with(body: {
    ...
    context 'with variables' do
      before do
        @trigger = Gitlab::Gem.run_trigger(3, '7b9148c158980bbd9bcea92c17522d', 'master', a: 10)
      end
