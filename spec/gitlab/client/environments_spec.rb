...
describe Gitlab::Client do
  describe '.environments' do
    before do
      ...
      @environments = Gitlab::Client.environments(3)
    end
  ...
  describe '.environment' do
    before do
      ...
      @environment = Gitlab::Client.environment(3, 12)
    end
  ...
  describe '.create_environment' do
    context 'without external_url' do
      before do
        ...
        @environment = Gitlab::Client.create_environment(3, 'staging')
      end
    ...
    context 'with external_url' do
      before do
        stub_post('/projects/3/environments', 'environment')
        @environment = Gitlab::Client.create_environment(3, 'staging', external_url: 'https://staging.example.gitlab.com')
      end
  ...
  describe '.edit_environment' do
    before do
      ...
      @environment = Gitlab::Client.edit_environment(3, 12,
                                                     name: 'staging',
  ...
  describe '.delete_environment' do
    before do
      ...
      @environment = Gitlab::Client.delete_environment(3, 12)
    end
  ...
  describe '.stop_environment' do
    before do
      ...
      @environment = Gitlab::Client.stop_environment(3, 12)
    end
