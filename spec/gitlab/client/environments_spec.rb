...
describe Gitlab::Gem::Client do
  describe '.environments' do
    before do
      ...
      @environments = Gitlab::Gem.environments(3)
    end
    ...
    it "returns a paginated response of project's environments" do
      expect(@environments).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.environment' do
    before do
      ...
      @environment = Gitlab::Gem.environment(3, 12)
    end
    ...
    it 'returns a single environment' do
      expect(@environment).to be_a Gitlab::Gem::ObjectifiedHash
    end
  ...
  describe '.create_environment' do
    context 'without external_url' do
      before do
        ...
        @environment = Gitlab::Gem.create_environment(3, 'staging')
      end
    ...
    context 'with external_url' do
      before do
        stub_post('/projects/3/environments', 'environment')
        @environment = Gitlab::Gem.create_environment(3, 'staging', external_url: 'https://staging.example.gitlab.com')
      end
  ...
  describe '.edit_environment' do
    before do
      ...
      @environment = Gitlab::Gem.edit_environment(3, 12,
                                             name: 'staging',
  ...
  describe '.delete_environment' do
    before do
      ...
      @environment = Gitlab::Gem.delete_environment(3, 12)
    end
  ...
  describe '.stop_environment' do
    before do
      ...
      @environment = Gitlab::Gem.stop_environment(3, 12)
    end
