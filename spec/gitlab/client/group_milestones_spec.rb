...
describe Gitlab::Gem::Client do
  describe '.group_milestones' do
    before do
      ...
      @milestones = Gitlab::Gem.group_milestones(3)
    end
  ...
  describe '.group_milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.group_milestone(3, 1)
    end
  ...
  describe '.create_group_milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.create_group_milestone(3, 'title')
    end
  ...
  describe '.edit_group_milestone' do
    before do
      ...
      @milestone = Gitlab::Gem.edit_group_milestone(3, 33, title: 'title')
    end
  ...
  describe '.group_milestone_issues' do
    before do
      ...
      @milestone_issues = Gitlab::Gem.group_milestone_issues(3, 1)
    end
  ...
  describe '.group_milestone_merge_requests' do
    before do
      ...
      @milestone_merge_requests = Gitlab::Gem.group_milestone_merge_requests(3, 1)
    end
