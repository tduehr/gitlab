...
describe Gitlab::Client do
  describe '.issue_state_events' do
    before do
      ...
      @events = Gitlab::Client.issue_state_events(5, 42)
    end
  ...
  describe '.issue_state_event' do
    before do
      ...
      @event = Gitlab::Client.issue_state_event(5, 42, 142)
    end
  ...
  describe '.merge_request_state_events' do
    before do
      ...
      @events = Gitlab::Client.merge_request_state_events(5, 42)
    end
  ...
  describe '.merge_request_state_event' do
    before do
      ...
      @event = Gitlab::Client.merge_request_state_event(5, 42, 142)
    end
