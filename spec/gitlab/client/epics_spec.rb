...
describe Gitlab::Client do
  ...
  describe '.create_epic' do
    before do
      ...
      Gitlab::Client.create_epic(1, 'foo', description: 'bar')
    end
  ...
  describe '.edit_epic' do
    before do
      ...
      Gitlab::Client.edit_epic(1, 2, title: 'mepmep')
    end
