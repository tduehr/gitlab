...
describe Gitlab::Gem::Client do
  ...
  describe '.issue_links' do
    before do
      ...
      @issue_link = Gitlab::Gem.issue_links(4, 14)
    end
    ...
    it 'returns a paginated response of projects' do
      expect(@issue_link).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.create_issue_link' do
    before do
      ...
      @issue_link = Gitlab::Gem.create_issue_link(3, 14, 4, 11)
    end
  ...
  describe '.delete_issue_link' do
    before do
      ...
      @issue_link = Gitlab::Gem.delete_issue_link(3, 14, 1)
    end
