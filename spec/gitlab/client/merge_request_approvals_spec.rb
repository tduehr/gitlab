...
describe Gitlab::Gem::Client do
  describe '.project_merge_request_approvals' do
    before do
      ...
      @project_mr_approvals = Gitlab::Gem.project_merge_request_approvals(1)
    end
    ...
    it 'returns the correct objectified hash' do
      expect(@project_mr_approvals).to be_a Gitlab::Gem::ObjectifiedHash
    end
  end
  ...
  describe '.edit_project_merge_request_approvals' do
    before do
      ...
      @project_mr_approvals = Gitlab::Gem.edit_project_merge_request_approvals(1, approvals_before_merge: 3, reset_approvals_on_push: false, disable_overriding_approvers_per_merge_request: true)
    end
  ...
  describe '.project_merge_request_approval_rules' do
    before do
      ...
      @project_mr_approval_rules = Gitlab::Gem.project_merge_request_approval_rules(1)
    end
    ...
    it 'returns the paginated list of approval rules' do
      expect(@project_mr_approval_rules).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.create_project_merge_request_approval_rule' do
    before do
      ...
      @project_mr_approval_rules = Gitlab::Gem.create_project_merge_request_approval_rule(1, name: 'security', approvals_required: 1)
    end
  ...
  describe '.update_project_merge_request_approval_rule' do
    before do
      ...
      @project_mr_approval_rules = Gitlab::Gem.update_project_merge_request_approval_rule(1, 1, name: 'security', approvals_required: 1)
    end
  ...
  describe '.edit_project_approvers' do
    before do
      ...
      @project_mr_approvals = Gitlab::Gem.edit_project_approvers(1, approver_ids: [5], approver_group_ids: [1])
    end
  ...
  describe '.merge_request_approvals' do
    before do
      ...
      @merge_request_approvals = Gitlab::Gem.merge_request_approvals(1, 5)
    end
    ...
    it 'returns the correct objectified hash' do
      expect(@merge_request_approvals).to be_a Gitlab::Gem::ObjectifiedHash
  ...
  describe '.edit_merge_request_approvals' do
    before do
      ...
      @merge_request_approvals = Gitlab::Gem.edit_merge_request_approvals(1, 5, approvals_required: 2)
    end
  ...
  describe '.edit_merge_request_approvers' do
    before do
      ...
      @merge_request_approvals = Gitlab::Gem.edit_merge_request_approvers(1, 5, approver_ids: [1], approver_group_ids: [5])
    end
  ...
  describe '.approve_merge_request' do
    before do
      ...
      @merge_request_approvals = Gitlab::Gem.approve_merge_request(1, 5)
    end
  ...
  describe '.unapprove_merge_request' do
    before do
      ...
      @merge_request_approvals = Gitlab::Gem.unapprove_merge_request(1, 5)
    end
  ...
  describe '.merge_request_approval_state' do
    before do
      ...
      @approval_state = Gitlab::Gem.merge_request_approval_state(3, 1)
    end
