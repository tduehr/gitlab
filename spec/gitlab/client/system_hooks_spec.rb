...
describe Gitlab::Client do
  ...
  describe '.add_hook' do
    before do
      ...
      @hook = Gitlab::Client.add_hook('http://example.com/hook', token: 'secret-token')
    end
  ...
  describe '.delete_hook' do
    before do
      ...
      @hook = Gitlab::Client.delete_hook(3)
    end
