  ...
  describe 'notes' do
    ...
    context 'when issue notes' do
      before do
        ...
        @notes = Gitlab::Client.issue_notes(3, 7)
      end
    ...
    context 'when snippet notes' do
      before do
        ...
        @notes = Gitlab::Client.snippet_notes(3, 7)
      end
    ...
    context 'when merge_request notes' do
      before do
        ...
        @notes = Gitlab::Client.merge_request_notes(3, 7)
      end
    ...
    context 'when epic notes' do
      before do
        ...
        @notes = Gitlab::Client.epic_notes(3, 7)
      end
  ...
  describe 'note' do
    context 'when wall note' do
      before do
        ...
        @note = Gitlab::Client.note(3, 1201)
      end
    ...
    context 'when issue note' do
      before do
        ...
        @note = Gitlab::Client.issue_note(3, 7, 1201)
      end
    ...
    context 'when snippet note' do
      before do
        ...
        @note = Gitlab::Client.snippet_note(3, 7, 1201)
      end
    ...
    context 'when merge request note' do
      before do
        ...
        @note = Gitlab::Client.merge_request_note(3, 7, 1201)
      end
  ...
  describe 'create note' do
    context 'when wall note' do
      before do
        ...
        @note = Gitlab::Client.create_note(3, 'The solution is rather tricky')
      end
    ...
    context 'when issue note' do
      before do
        ...
        @note = Gitlab::Client.create_issue_note(3, 7, 'The solution is rather tricky')
      end
    ...
    context 'when snippet note' do
      before do
        ...
        @note = Gitlab::Client.create_snippet_note(3, 7, 'The solution is rather tricky')
      end
    ...
    context 'when merge_request note' do
      before do
        ...
        @note = Gitlab::Client.create_merge_request_note(3, 7, 'The solution is rather tricky')
      end
    ...
    context 'when epic note' do
      before do
        ...
        @note = Gitlab::Client.create_epic_note(3, 7, 'The solution is rather tricky')
      end
  ...
  describe 'delete note' do
    context 'when wall note' do
      before do
        ...
        @note = Gitlab::Client.delete_note(3, 1201)
      end
    ...
    context 'when issue note' do
      before do
        ...
        @note = Gitlab::Client.delete_issue_note(3, 7, 1201)
      end
    ...
    context 'when snippet note' do
      before do
        ...
        @note = Gitlab::Client.delete_snippet_note(3, 7, 1201)
      end
    ...
    context 'when merge request note' do
      before do
        ...
        @note = Gitlab::Client.delete_merge_request_note(3, 7, 1201)
      end
  ...
  describe 'modify note' do
    context 'when wall note' do
      before do
        ...
        @note = Gitlab::Client.edit_note(3, 1201, 'edited wall note content')
      end
    ...
    context 'when issue note' do
      before do
        ...
        @note = Gitlab::Client.edit_issue_note(3, 7, 1201, 'edited issue note content')
      end
    ...
    context 'when snippet note' do
      before do
        ...
        @note = Gitlab::Client.edit_snippet_note(3, 7, 1201, 'edited snippet note content')
      end
    ...
    context 'when merge request note' do
      before do
        ...
        @note = Gitlab::Client.edit_merge_request_note(3, 7, 1201, 'edited merge request note content')
      end
