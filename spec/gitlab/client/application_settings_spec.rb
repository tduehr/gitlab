...
describe Gitlab::Gem::Client do
  ...
  describe '.application_settings' do
    before do
      ...
      @application_settings = Gitlab::Gem.application_settings
    end
    ...
    it 'returns a paginated response of projects' do
      expect(@application_settings).to be_a Gitlab::Gem::ObjectifiedHash
  ...
  describe '.edit_application_settings' do
    before do
      ...
      @edited_application_settings = Gitlab::Gem.edit_application_settings(signup_enabled: true)
    end
