  ...
  describe '.award_emojis' do
    context 'when issue award emojis' do
      before do
        ...
        @emojis = Gitlab::Client.award_emojis(1, 80, 'issue')
      end
    ...
    context 'when merge request award emojis' do
      before do
        ...
        @emojis = Gitlab::Client.award_emojis(1, 80, 'merge_request')
      end
    ...
    context 'when snippet award emojis' do
      before do
        ...
        @emojis = Gitlab::Client.award_emojis(1, 80, 'snippet')
      end
  ...
  describe '.note_award_emojis' do
    context 'when issue note award emojis' do
      before do
        ...
        @note_emojis = Gitlab::Client.note_award_emojis(1, 80, 'issue', 1)
      end
    ...
    context 'when merge request note award emojis' do
      before do
        ...
        @note_emojis = Gitlab::Client.note_award_emojis(1, 80, 'merge_request', 1)
      end
    ...
    context 'when snippet note award emojis' do
      before do
        ...
        @note_emojis = Gitlab::Client.note_award_emojis(1, 80, 'snippet', 1)
      end
  ...
  describe '.award_emoji' do
    context 'when issue award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.award_emoji(1, 80, 'issue', 4)
      end
    ...
    context 'when merge request award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.award_emoji(1, 80, 'merge_request', 4)
      end
    ...
    context 'when snippet award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.award_emoji(1, 80, 'snippet', 4)
      end
  ...
  describe '.note_award_emoji' do
    context 'when issue note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.note_award_emoji(1, 80, 'issue', 1, 4)
      end
    ...
    context 'when merge request note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.note_award_emoji(1, 80, 'merge_request', 1, 4)
      end
    ...
    context 'when snippet note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.note_award_emoji(1, 80, 'snippet', 1, 4)
      end
  ...
  describe '.create_award_emoji' do
    context 'when issue award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.create_award_emoji(1, 80, 'issue', 'blowfish')
      end
    ...
    context 'when merge request award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.create_award_emoji(1, 80, 'merge_request', 'blowfish')
      end
    ...
    context 'when snippet award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.create_award_emoji(1, 80, 'snippet', 'blowfish')
      end
  ...
  describe '.create_note_award_emoji' do
    context 'when issue note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.create_note_award_emoji(1, 80, 'issue', 1, 'mood_bubble_lightning')
      end
    ...
    context 'when merge request note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.create_note_award_emoji(1, 80, 'merge_request', 1, 'mood_bubble_lightning')
      end
    ...
    context 'when snippet note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.create_note_award_emoji(1, 80, 'snippet', 1, 'mood_bubble_lightning')
      end
  ...
  describe '.delete_award_emoji' do
    context 'when issue award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.delete_award_emoji(1, 80, 'issue', 4)
      end
    ...
    context 'when merge request award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.delete_award_emoji(1, 80, 'merge_request', 4)
      end
    ...
    context 'when snippet award emoji' do
      before do
        ...
        @emoji = Gitlab::Client.delete_award_emoji(1, 80, 'snippet', 4)
      end
  ...
  describe '.delete_note_award_emoji' do
    context 'when issue note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.delete_note_award_emoji(1, 80, 'issue', 1, 4)
      end
    ...
    context 'when merge request note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.delete_note_award_emoji(1, 80, 'merge_request', 1, 4)
      end
    ...
    context 'when snippet note award emoji' do
      before do
        ...
        @note_emoji = Gitlab::Client.delete_note_award_emoji(1, 80, 'snippet', 1, 4)
      end
