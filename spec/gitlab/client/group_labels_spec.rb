...
describe Gitlab::Client do
  describe '.group_labels' do
    before do
      ...
      @labels = Gitlab::Client.group_labels(3)
    end
  ...
  describe '.create_group_label' do
    before do
      ...
      @label = Gitlab::Client.create_group_label(3, 'Backlog', '#DD10AA')
    end
  ...
  describe '.edit_group_label' do
    before do
      ...
      @label = Gitlab::Client.edit_group_label(3, 'TODO', new_name: 'Backlog')
    end
  ...
  describe '.delete_group_label' do
    before do
      ...
      @label = Gitlab::Client.delete_group_label(3, 'Backlog')
    end
  ...
  describe '.subscribe_to_group_label' do
    before do
      ...
      @label = Gitlab::Client.subscribe_to_group_label(3, 'Backlog')
    end
  ...
  describe '.unsubscribe_from_group_label' do
    before do
      ...
      @label = Gitlab::Client.unsubscribe_from_group_label(3, 'Backlog')
    end
