...
describe Gitlab::Gem::Client do
  describe '.broadcast_messages' do
    before do
      ...
      @broadcast_messages = Gitlab::Gem.broadcast_messages
    end
    ...
    it 'returns a paginated response of broadcast messages' do
      expect(@broadcast_messages).to be_a Gitlab::Gem::PaginatedResponse
    end
  end
  ...
  describe '.broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Gem.broadcast_message(1)
    end
  ...
  describe '.create_broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Gem.create_broadcast_message('Deploy in progress', color: '#cecece')
    end
  ...
  describe '.edit_broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Gem.edit_broadcast_message(1, font: '#FFFFFF')
    end
  ...
  describe '.delete_broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Gem.delete_broadcast_message(1)
    end
