...
describe Gitlab::Client do
  describe '.broadcast_messages' do
    before do
      ...
      @broadcast_messages = Gitlab::Client.broadcast_messages
    end
  ...
  describe '.broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Client.broadcast_message(1)
    end
  ...
  describe '.create_broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Client.create_broadcast_message('Deploy in progress', color: '#cecece')
    end
  ...
  describe '.edit_broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Client.edit_broadcast_message(1, font: '#FFFFFF')
    end
  ...
  describe '.delete_broadcast_message' do
    before do
      ...
      @broadcast_message = Gitlab::Client.delete_broadcast_message(1)
    end
