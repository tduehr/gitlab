...
describe Gitlab::Client do
  describe '.variables' do
    before do
      ...
      @variables = Gitlab::Client.variables(3)
    end
  ...
  describe '.variable' do
    before do
      ...
      @variable = Gitlab::Client.variable(3, 'VARIABLE')
    end
  ...
  describe '.create_variable' do
    before do
      ...
      @variable = Gitlab::Client.create_variable(3, 'NEW_VARIABLE', 'new value')
    end
  ...
  describe '.update_variable' do
    before do
      ...
      @variable = Gitlab::Client.update_variable(3, 'UPD_VARIABLE', 'updated value')
    end
  ...
  describe '.remove_variable' do
    before do
      ...
      @variable = Gitlab::Client.remove_variable(3, 'DEL_VARIABLE')
    end
  ...
  describe '.group_variables' do
    before do
      ...
      @variables = Gitlab::Client.group_variables(3)
    end
  ...
  describe '.group_variable' do
    before do
      ...
      @variable = Gitlab::Client.group_variable(3, 'VARIABLE')
    end
  ...
  describe '.create_group_variable' do
    before do
      ...
      @variable = Gitlab::Client.create_group_variable(3, 'NEW_VARIABLE', 'new value')
    end
  ...
  describe '.update_group_variable' do
    before do
      ...
      @variable = Gitlab::Client.update_group_variable(3, 'UPD_VARIABLE', 'updated value')
    end
  ...
  describe '.remove_group_variable' do
    before do
      ...
      @variable = Gitlab::Client.remove_group_variable(3, 'DEL_VARIABLE')
    end
