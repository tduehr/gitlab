...
describe Gitlab::Gem::Client do
  describe '.variables' do
    before do
      ...
      @variables = Gitlab::Gem.variables(3)
    end
    ...
    it "returns an array of project's variables" do
      expect(@variables).to be_a Gitlab::Gem::PaginatedResponse
  ...
  describe '.variable' do
    before do
      ...
      @variable = Gitlab::Gem.variable(3, 'VARIABLE')
    end
  ...
  describe '.create_variable' do
    before do
      ...
      @variable = Gitlab::Gem.create_variable(3, 'NEW_VARIABLE', 'new value')
    end
  ...
  describe '.update_variable' do
    before do
      ...
      @variable = Gitlab::Gem.update_variable(3, 'UPD_VARIABLE', 'updated value')
    end
  ...
  describe '.remove_variable' do
    before do
      ...
      @variable = Gitlab::Gem.remove_variable(3, 'DEL_VARIABLE')
    end
  ...
  describe '.group_variables' do
    before do
      ...
      @variables = Gitlab::Gem.group_variables(3)
    end
  ...
  describe '.group_variable' do
    before do
      ...
      @variable = Gitlab::Gem.group_variable(3, 'VARIABLE')
    end
  ...
  describe '.create_group_variable' do
    before do
      ...
      @variable = Gitlab::Gem.create_group_variable(3, 'NEW_VARIABLE', 'new value')
    end
  ...
  describe '.update_group_variable' do
    before do
      ...
      @variable = Gitlab::Gem.update_group_variable(3, 'UPD_VARIABLE', 'updated value')
    end
  ...
  describe '.remove_group_variable' do
    before do
      ...
      @variable = Gitlab::Gem.remove_group_variable(3, 'DEL_VARIABLE')
    end
