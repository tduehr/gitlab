...
describe Gitlab::Client do
  describe '.pipeline_schedules' do
    before do
      ...
      @pipeline_schedules = Gitlab::Client.pipeline_schedules(3)
    end
  ...
  describe '.pipeline_schedule' do
    before do
      ...
      @pipeline_schedule = Gitlab::Client.pipeline_schedule(3, 5)
    end
  ...
  describe '.create_pipeline_schedule' do
    before do
      ...
      @pipeline_schedule_create = Gitlab::Client.create_pipeline_schedule(3)
    end
  ...
  describe '.edit_pipeline_schedule' do
    before do
      ...
      @pipeline_schedule_update = Gitlab::Client.edit_pipeline_schedule(3, 13)
    end
  ...
  describe '.pipeline_schedule_take_ownership' do
    before do
      ...
      @pipeline_schedule = Gitlab::Client.pipeline_schedule_take_ownership(3, 13)
    end
  ...
  describe '.delete_pipeline_schedule' do
    before do
      ...
      @pipeline_schedule = Gitlab::Client.delete_pipeline_schedule(3, 13)
    end
  ...
  describe '.create_pipeline_schedule_variable' do
    before do
      ...
      @pipeline_schedule_variable = Gitlab::Client.create_pipeline_schedule_variable(3, 13,
                                                                                     key: 'NEW VARIABLE',
                                                                                     value: 'new value')
    end
  ...
  describe '.edit_pipeline_schedule_variable' do
    before do
      ...
      @pipeline_schedule_variable = Gitlab::Client.edit_pipeline_schedule_variable(3, 13, 'NEW VARIABLE', value: 'update value')
    end
  ...
  describe '.delete_pipeline_schedule_variable' do
    before do
      ...
      @pipeline_schedule_variable = Gitlab::Client.delete_pipeline_schedule_variable(3, 13, 'NEW VARIABLE')
    end
