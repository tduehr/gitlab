...
describe Gitlab::Gem::Client do
  describe '.file_contents' do
    before do
      ...
      @file_contents = Gitlab::Gem.file_contents(3, 'Gemfile')
    end
  ...
  describe '.get_file_blame' do
    before do
      ...
      @blames = Gitlab::Gem.get_file_blame(3, 'README.md', 'master')
    end
  ...
  describe '.get_file' do
    before do
      ...
      @file = Gitlab::Gem.get_file(3, 'README.md', 'master')
    end
  ...
  describe '.create_file' do
    ...
    let!(:file) { Gitlab::Gem.create_file(3, 'path', 'branch', 'content', 'commit message', author_name: 'joe') }
  ...
  describe '.edit_file' do
    ...
    let!(:file) { Gitlab::Gem.edit_file(3, 'path', 'branch', 'content', 'commit message', author_name: 'joe') }
  ...
  describe '.remove_file' do
    ...
    let!(:file) { Gitlab::Gem.remove_file(3, 'path', 'branch', 'commit message', author_name: 'joe') }
