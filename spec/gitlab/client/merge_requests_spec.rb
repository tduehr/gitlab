...
describe Gitlab::Client do
  describe '.user_merge_requests' do
    before do
      ...
      @user_merge_requests = Gitlab::Client.user_merge_requests
    end
  ...
  describe '.merge_requests' do
    before do
      ...
      @merge_requests = Gitlab::Client.merge_requests(3)
    end
  ...
  describe '.merge_request' do
    before do
      ...
      @merge_request = Gitlab::Client.merge_request(3, 1)
    end
  ...
  describe '.merge_request_participants' do
    before do
      ...
      Gitlab::Client.merge_request_participants(3, 1)
    end
  ...
  describe '.merge_request_pipelines' do
    before do
      ...
      @pipelines = Gitlab::Client.merge_request_pipelines(3, 1)
    end
  ...
  describe '.create_merge_request' do
    ...
    it 'returns information about a merge request' do
      @merge_request = Gitlab::Client.create_merge_request(3, 'New feature',
                                                           source_branch: 'api',
  ...
  describe '.update_merge_request' do
    before do
      ...
      @merge_request = Gitlab::Client.update_merge_request(3, 2,
                                                           assignee_id: '1',
                                                           target_branch: 'master',
                                                           title: 'A different new feature')
    end
  ...
  describe '.accept_merge_request' do
    before do
      ...
      @merge_request = Gitlab::Client.accept_merge_request(5, 42, merge_commit_message: 'Nice!')
    end
  ...
  describe '.merge_request_comments' do
    before do
      ...
      @merge_request = Gitlab::Client.merge_request_comments(3, 2)
    end
  ...
  describe '.create_merge_request_comment' do
    before do
      ...
      @merge_request = Gitlab::Client.create_merge_request_comment(3, 2, 'Cool Merge Request!')
    end
  ...
  describe '.merge_request_changes' do
    before do
      ...
      @mr_changes = Gitlab::Client.merge_request_changes(3, 2)
    end
  ...
  describe '.merge_request_commits' do
    before do
      ...
      @mr_commits = Gitlab::Client.merge_request_commits(3, 2)
    end
  ...
  describe '.merge_request_closes_issues' do
    before do
      ...
      @issues = Gitlab::Client.merge_request_closes_issues(5, 1)
    end
  ...
  describe '.subscribe_to_merge_request' do
    before do
      ...
      @merge_request = Gitlab::Client.subscribe_to_merge_request(3, 2)
    end
  ...
  describe '.unsubscribe_from_merge_request' do
    before do
      ...
      @merge_request = Gitlab::Client.unsubscribe_from_merge_request(3, 2)
    end
  ...
  describe '.merge_request_discussions' do
    before do
      ...
      @discussions = Gitlab::Client.merge_request_discussions(3, 2)
    end
  ...
  describe '.merge_request_discussion' do
    before do
      ...
      @discussion = Gitlab::Client.merge_request_discussion(3, 2, 1)
    end
  ...
  describe '.create_merge_request_discussion' do
    before do
      ...
      @discussion = Gitlab::Client.create_merge_request_discussion(3, 2, body: 'Discussion', position: { old_line: 1 })
    end
  ...
  describe '.resolve_merge_request_discussion' do
    before do
      ...
      @discussion = Gitlab::Client.resolve_merge_request_discussion(3, 2, 1, resolved: true)
    end
  ...
  describe '.create_merge_request_discussion_note' do
    before do
      ...
      @note = Gitlab::Client.create_merge_request_discussion_note(3, 2, 1, body: 'note')
    end
  ...
  describe '.update_merge_request_discussion_note' do
    before do
      ...
      @note = Gitlab::Client.update_merge_request_discussion_note(3, 2, 1, 1, body: 'note2')
    end
  ...
  describe '.delete_merge_request_discussion_note' do
    before do
      ...
      @note = Gitlab::Client.delete_merge_request_discussion_note(3, 2, 1, 1)
    end
  ...
  describe '.merge_request_diff_versions' do
    before do
      ...
      @versions = Gitlab::Client.merge_request_diff_versions(3, 105)
    end
  ...
  describe '.merge_request_diff_version' do
    before do
      ...
      @diff = Gitlab::Client.merge_request_diff_version(3, 105, 1)
    end
