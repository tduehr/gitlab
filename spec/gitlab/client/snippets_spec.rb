...
describe Gitlab::Gem::Client do
  describe '.snippets' do
    before do
      ...
      @snippets = Gitlab::Gem.snippets(3)
    end
  ...
  describe '.snippet' do
    before do
      ...
      @snippet = Gitlab::Gem.snippet(3, 1)
    end
  ...
  describe '.create_snippet' do
    before do
      ...
      @snippet = Gitlab::Gem.create_snippet(3, title: 'API', file_name: 'api.rb', code: 'code', visibility: 'public')
    end
  ...
  describe '.edit_snippet' do
    before do
      ...
      @snippet = Gitlab::Gem.edit_snippet(3, 1, file_name: 'mailer_test.rb')
    end
  ...
  describe '.delete_snippet' do
    before do
      ...
      @snippet = Gitlab::Gem.delete_snippet(3, 1)
    end
  ...
  describe '.snippet_content' do
    before do
      ...
      @snippet_content = Gitlab::Gem.snippet_content(3, 1)
    end
