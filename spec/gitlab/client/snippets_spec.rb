...
describe Gitlab::Client do
  describe '.snippets' do
    before do
      ...
      @snippets = Gitlab::Client.snippets(3)
    end
  ...
  describe '.snippet' do
    before do
      ...
      @snippet = Gitlab::Client.snippet(3, 1)
    end
  ...
  describe '.create_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.create_snippet(3, title: 'API', file_name: 'api.rb', code: 'code', visibility: 'public')
    end
  ...
  describe '.edit_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.edit_snippet(3, 1, file_name: 'mailer_test.rb')
    end
  ...
  describe '.delete_snippet' do
    before do
      ...
      @snippet = Gitlab::Client.delete_snippet(3, 1)
    end
  ...
  describe '.snippet_content' do
    before do
      ...
      @snippet_content = Gitlab::Client.snippet_content(3, 1)
    end
