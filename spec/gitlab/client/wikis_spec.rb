...
describe Gitlab::Client do
  ...
  describe '.wiki' do
    before do
      ...
      @wiki = Gitlab::Client.wiki(1, 'home')
    end
  ...
  describe '.create_wiki' do
    before do
      ...
      @wiki = Gitlab::Client.create_wiki(1, 'home', 'home page')
    end
  ...
  describe '.update_wiki' do
    before do
      ...
      @wiki = Gitlab::Client.update_wiki(1, 'home', format: 'markdown')
    end
  ...
  describe '.delete_wiki' do
    before do
      ...
      @wiki = Gitlab::Client.delete_wiki(1, 'home')
    end
