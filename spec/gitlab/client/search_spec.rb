  ...
  describe '.search_globally' do
    context 'when scope projects' do
      before do
        ...
        @search = Gitlab::Gem.search_globally('projects', 'flight')
      end
      ...
      it 'returns a paginated response of search results' do
        expect(@search).to be_a Gitlab::Gem::PaginatedResponse
      end
    end
    ...
    context 'when scope issues' do
      before do
        ...
        @search = Gitlab::Gem.search_globally('issues', 'file')
      end
    ...
    context 'when scope merge_requests' do
      before do
        ...
        @search = Gitlab::Gem.search_globally('merge_requests', 'file')
      end
    ...
    context 'when scope milestones' do
      before do
        ...
        @search = Gitlab::Gem.search_globally('milestones', 'release')
      end
    ...
    context 'when scope snippet_titles' do
      before do
        ...
        @search = Gitlab::Gem.search_globally('snippet_titles', 'sample')
      end
    ...
    context 'when scope snippet_blobs' do
      before do
        ...
        @search = Gitlab::Gem.search_globally('snippet_blobs', 'test')
      end
  ...
  describe '.search_in_group' do
    context 'when scope projects' do
      before do
        ...
        @search = Gitlab::Gem.search_in_group(3, 'projects', 'flight')
      end
    ...
    context 'when scope issues' do
      before do
        ...
        @search = Gitlab::Gem.search_in_group(3, 'issues', 'file')
      end
    ...
    context 'when scope merge_requests' do
      before do
        ...
        @search = Gitlab::Gem.search_in_group(3, 'merge_requests', 'file')
      end
    ...
    context 'when scope milestones' do
      before do
        ...
        @search = Gitlab::Gem.search_in_group(3, 'milestones', 'release')
      end
  ...
  describe '.search_in_project' do
    context 'when scope issues' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(12, 'issues', 'file')
      end
    ...
    context 'when scope merge_requests' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(6, 'merge_requests', 'file')
      end
    ...
    context 'when scope milestones' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(12, 'milestones', 'release')
      end
    ...
    context 'when scope notes' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(6, 'notes', 'maxime')
      end
    ...
    context 'when scope wiki_blobs' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(6, 'wiki_blobs', 'bye')
      end
    ...
    context 'when scope commits' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(6, 'commits', 'bye')
      end
    ...
    context 'when scope blobs' do
      before do
        ...
        @search = Gitlab::Gem.search_in_project(6, 'blobs', 'installation')
      end
