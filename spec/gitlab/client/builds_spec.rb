...
describe Gitlab::Client do
  ...
  describe '.build_artifacts' do
    context 'when successful request' do
      before do
        ...
        stub_request(:get, "#{Gitlab::Client.endpoint}/projects/3/builds/8/artifacts")
        ...
        @build_artifacts = Gitlab::Client.build_artifacts(3, 8)
      end
    ...
    context 'when bad request' do
      it 'throws an exception' do
        ...
        expect { Gitlab::Client.build_artifacts(3, 8) }.to raise_error(Gitlab::Client::Error::NotFound, "Server responded with code 404, message: 404 Project Not Found. Request URI: #{Gitlab::Client.endpoint}/projects/3/builds/8/artifacts")
      end
    end
  end
  ...
  describe '.builds_commits' do
    before do
      ...
      @builds_commits = Gitlab::Client.commit_builds(3, '0ff3ae198f8601a285adcf5c0fff204ee6fba5fd')
    end
  ...
  describe '.build_cancel' do
    before do
      ...
      @build_cancel = Gitlab::Client.build_cancel(3, 8)
    end
  ...
  describe '.build_retry' do
    before do
      ...
      @build_retry = Gitlab::Client.build_retry(3, 69)
    end
  ...
  describe '.build_erase' do
    before do
      ...
      @build_retry = Gitlab::Client.build_erase(3, 69)
    end
