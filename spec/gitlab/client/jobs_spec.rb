...
describe Gitlab::Client do
  ...
  describe '.jobs - with scopes' do
    before do
      ...
      @projects = Gitlab::Client.jobs(1, scope: %w[created running])
    end
  ...
  describe '.pipeline_jobs' do
    before do
      ...
      @projects = Gitlab::Client.pipeline_jobs(1, 1)
    end
  ...
  describe '.pipeline_jobs - with scope' do
    before do
      ...
      @projects = Gitlab::Client.pipeline_jobs(1, 1, scope: %w[running created])
    end
  ...
  describe '.pipeline_bridges' do
    before do
      ...
      @jobs = Gitlab::Client.pipeline_bridges(1, 1)
    end
  ...
  describe '.pipeline_bridges - with scope' do
    before do
      ...
      @jobs = Gitlab::Client.pipeline_bridges(1, 1, scope: %w[running created])
    end
  ...
  describe '.job' do
    before do
      ...
      @projects = Gitlab::Client.job(1, 1)
    end
  ...
  describe '.job_artifacts' do
    before do
      ...
      @projects = Gitlab::Client.job_artifacts(1, 1)
    end
  ...
  describe '.job_artifacts_download' do
    context 'when successful request' do
      before do
        ...
        stub_request(:get, "#{Gitlab::Client.endpoint}/projects/3/jobs/artifacts/master/download")
          .with(query: { job: 'test' }, headers: { 'PRIVATE-TOKEN' => Gitlab::Client.private_token })
          .to_return(body: fixture.read, headers: { 'Content-Disposition' => 'attachment; filename=job_artifacts.zip' })
        @job_artifacts = Gitlab::Client.job_artifacts_download(3, 'master', 'test')
      end
    ...
    context 'when bad request' do
      it 'throws an exception' do
        stub_get('/projects/3/jobs/artifacts/master/download', 'error_project_not_found', 404)
          .with(query: { job: 'test' })
        expect { Gitlab::Client.job_artifacts_download(3, 'master', 'test') }.to raise_error(Gitlab::Client::Error::NotFound, "Server responded with code 404, message: 404 Project Not Found. Request URI: #{Gitlab::Client.endpoint}/projects/3/jobs/artifacts/master/download")
      end
    end
  end
  ...
  describe '.download_job_artifact_file' do
    context 'when successful request' do
      before do
        ...
        fixture.set_encoding(Encoding::ASCII_8BIT)
        stub_request(:get, "#{Gitlab::Client.endpoint}/projects/3/jobs/5/artifacts/raw_file.txt")
        ...
        @job_artifact_file = Gitlab::Client.download_job_artifact_file(3, 5, 'raw_file.txt')
      end
    ...
    context 'when bad request' do
      it 'throws an exception' do
        ...
        expect { Gitlab::Client.download_job_artifact_file(3, 5, 'raw_file.txt') }.to raise_error(Gitlab::Client::Error::NotFound, "Server responded with code 404, message: 404 Project Not Found. Request URI: #{Gitlab::Client.endpoint}/projects/3/jobs/5/artifacts/raw_file.txt")
      end
    end
  end
  ...
  describe '.download_branch_artifact_file' do
    context 'when successful request' do
      before do
        fixture = load_fixture('raw_file.txt')
        fixture.set_encoding(Encoding::ASCII_8BIT)
        stub_request(:get, "#{Gitlab::Client.endpoint}/projects/1/jobs/artifacts/master/raw/raw_file.txt")
          .with(query: { job: 'txt' }, headers: { 'PRIVATE-TOKEN' => Gitlab::Client.private_token })
          .to_return(body: fixture.read, headers: { 'Content-Disposition' => 'attachment; filename=raw_file.txt' })
        @branch_artifact_file = Gitlab::Client.download_branch_artifact_file(1, 'master', 'raw_file.txt', 'txt')
      end
    ...
    context 'when bad request' do
      it 'throws an exception' do
        stub_get('/projects/1/jobs/artifacts/master/raw/raw_file.txt', 'error_project_not_found', 404)
          .with(query: { job: 'txt' })
        expect { Gitlab::Client.download_branch_artifact_file(1, 'master', 'raw_file.txt', 'txt') }.to raise_error(Gitlab::Client::Error::NotFound, "Server responded with code 404, message: 404 Project Not Found. Request URI: #{Gitlab::Client.endpoint}/projects/1/jobs/artifacts/master/raw/raw_file.txt")
      end
    end
  end
  ...
  describe '.download_tag_artifact_file' do
    context 'when successful request' do
      before do
        fixture = load_fixture('raw_file.txt')
        fixture.set_encoding(Encoding::ASCII_8BIT)
        stub_request(:get, "#{Gitlab::Client.endpoint}/projects/1/jobs/artifacts/release/raw/raw_file.txt")
          .with(query: { job: 'txt' }, headers: { 'PRIVATE-TOKEN' => Gitlab::Client.private_token })
          .to_return(body: fixture.read, headers: { 'Content-Disposition' => 'attachment; filename=raw_file.txt' })
        @branch_artifact_file = Gitlab::Client.download_tag_artifact_file(1, 'release', 'raw_file.txt', 'txt')
      end
    ...
    context 'when bad request' do
      it 'throws an exception' do
        stub_get('/projects/1/jobs/artifacts/release/raw/raw_file.txt', 'error_project_not_found', 404)
          .with(query: { job: 'txt' })
        expect { Gitlab::Client.download_tag_artifact_file(1, 'release', 'raw_file.txt', 'txt') }.to raise_error(Gitlab::Client::Error::NotFound, "Server responded with code 404, message: 404 Project Not Found. Request URI: #{Gitlab::Client.endpoint}/projects/1/jobs/artifacts/release/raw/raw_file.txt")
      end
    end
  end
  ...
  describe '.job_trace' do
    before do
      ...
      @projects = Gitlab::Client.job_trace(1, 1)
    end
  ...
  describe '.job_cancel' do
    before do
      ...
      @projects = Gitlab::Client.job_cancel(1, 1)
    end
  ...
  describe '.job_retry' do
    before do
      ...
      @projects = Gitlab::Client.job_retry(1, 1)
    end
  ...
  describe '.job_erase' do
    before do
      ...
      @projects = Gitlab::Client.job_erase(1, 1)
    end
  ...
  describe '.job_play' do
    before do
      ...
      @projects = Gitlab::Client.job_play(1, 1)
    end
  ...
  describe '.job_artifacts_keep' do
    before do
      ...
      @projects = Gitlab::Client.job_artifacts_keep(1, 1)
    end
  ...
  describe '.job_artifacts_delete' do
    before do
      ...
      @projects = Gitlab::Client.job_artifacts_delete(1, 1)
    end
