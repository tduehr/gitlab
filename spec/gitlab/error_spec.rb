...
describe Gitlab::Gem::Error::ResponseError do
  before do
  ...
  [
    { code: 401, parsed_response: Gitlab::Gem::ObjectifiedHash.new(message: 'Displayed message', error_description: 'should not be displayed', error: 'also will not be displayed') },
    { code: 404, parsed_response: Gitlab::Gem::ObjectifiedHash.new(error_description: 'Displayed error_description', error: 'also will not be displayed') },
    { code: 401, parsed_response: Gitlab::Gem::ObjectifiedHash.new(error: 'Displayed error') },
    { code: 500, parsed_response: Gitlab::Gem::ObjectifiedHash.new(embed_entity: { foo: ['bar'], sna: ['fu'] }, password: ['too short']) },
    { code: 403, parsed_response: Array.new(['First message.', 'Second message.']) },
    { code: 400, parsed_response: Gitlab::Gem::ObjectifiedHash.new(message: { error: 'Spam detected' }) }
  ...
  context 'parsing errors' do
    ...
    before do
      allow(response_double).to receive(:parsed_response)
        .and_raise(Gitlab::Gem::Error::Parsing)
    end
